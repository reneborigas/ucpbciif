define(function () {
    ...
    app.controller(
        'CommitteeOfficeListController',
        function CommitteeOfficeListController($http, $filter, $scope, $state, $timeout, toastr, appFactory, NgTableParams, blockUI) {
    ...
    app.controller(
        'CommitteeOfficeAddController',
        function CommitteeOfficeAddController($http, $filter, $scope, $state, $timeout, toastr, appFactory, NgTableParams) {
    ...
    app.controller(
        'CommitteeInfoController',
        function CommitteeInfoController($http, $filter, $scope, $state, $timeout, toastr, appFactory, NgTableParams, blockUI) {
                                    ...
                                    logDetails: [
                                        {
                                            action:
                                                ...
                                                committee.firstname +
                                                ' ' +
                                                committee.lastname, //Details of Log
                                        },
                                    ],
                                };
                                return appFactory.getContentTypeId('committee').then(function (data) {
    ...
    app.controller(
        'CommitteeOfficeInfoMemberController',
        function CommitteeOfficeInfoMemberController($http, $filter, $scope, $state, $timeout, toastr, appFactory, NgTableParams) {
            $scope.steps = [
                {
                    step: 1,
