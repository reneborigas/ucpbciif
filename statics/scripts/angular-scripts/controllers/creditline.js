define(function () {
    ...
    app.controller(
        'CreditLineListController',
        function CreditLineListController($http, $filter, $scope, $state, $timeout, toastr, appFactory, NgTableParams, $window, blockUI) {
                ...
                $scope.tableCreditLine = new NgTableParams(
                    ...
                    },
                    {
                        ...
                        getData: function (params) {
                            return $http.get('/api/loans/creditlineslist/', { params: $scope.params }).then(
                                function (response) {
            ...
            appFactory.getCreditLineStatus().then(function (data) {
                $scope.creditlinestatus = data;
            });
            ...
            $scope.filters = [
                ...
                {
                    name: 'Total Balance Range',
                    showFilter: false,
                    filterFormat: "currency :'₱'",
                    params: {
                        param1: 'totalCreditLineBalanceFrom',
                        param2: 'totalCreditLineBalanceTo',
                    },
                },
                {
                    name: 'Date Created Range',
                    showFilter: false,
                    filterFormat: "date : 'mediumDate'",
                    params: {
                        param1: 'dateCreatedFrom',
                        param2: 'dateCreatedTo',
                    },
                },
                {
    ...
    app.controller(
        'CreditLineInfoController',
        function CreditLineInfoController($http, $filter, $scope, toastr, NgTableParams, appFactory, $state, $timeout, blockUI, $q, $window) {
            $http
