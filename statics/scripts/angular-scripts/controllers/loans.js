define(function () {
    ...
    app.controller(
        'LoanListController',
        function LoanListController($http, $filter, $scope, toastr, NgTableParams, $state, $timeout, appFactory, $window, blockUI) {
    ...
    app.controller(
        'LoanInfoController',
        function LoanInfoController($http, $filter, $scope, toastr, NgTableParams, appFactory, $state, $timeout, blockUI, $q, $window) {
    ...
    app.controller(
        'LoanAmortizationRestructureController',
        function LoanAmortizationRestructureController(
            $http,
            $filter,
            $scope,
            toastr,
    ...
    app.controller(
        'CheckReleasePrintController',
        function CheckReleasePrintController($http, $filter, $scope, toastr, NgTableParams, $state, $timeout, appFactory, $window) {
            $scope.dateToday = new Date();
            $http
                .get('/api/loans/loans/', {
                    params: { loanId: $scope.loanId },
