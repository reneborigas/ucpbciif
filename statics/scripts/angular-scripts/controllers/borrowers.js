define(function () {
    ...
    app.controller(
        ...
        function BorrowerEditController($http, $filter, $scope, toastr, NgTableParams, appFactory, $state, $timeout, blockUI) {
            $scope.form = {};
            var staticData;
            var objectsRemoved = [];
                                ...
                                if (object1[prop] !== object2[prop]) {
                                    if (
                                        ...
                                        if (!object2[prop]) {
                                            ...
                                            objectsDiffering.push({
                                                action:
                                                    'Changed ' + appFactory.normalizeString(prop) + ' from ' + object2[prop] + ' to ' + object1[prop],
                                            });
                                        }
                                    }
                                }
