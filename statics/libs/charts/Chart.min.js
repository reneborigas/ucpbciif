...
!(function (t, e) {
        ...
        at = {
            ...
            drawPoint: function (t, e, i, n, a, o) {
                ...
                if (
                    !e ||
                    'object' != typeof e ||
                    ('[object HTMLImageElement]' !== (r = e.toString()) && '[object HTMLCanvasElement]' !== r)
                ) {
                    if (!(isNaN(i) || i <= 0)) {
                ...
                ? (a || (a = e._view = {}),
                  ...
                  (function (t, e, i, n) {
                      ...
                      for (a = 0, o = f.length; a < o; ++a)
                          if (
                              ((d = i[(r = f[a])]), e.hasOwnProperty(r) || (e[r] = d), (s = e[r]) !== d && '_' !== r[0])
                          ) {
    ...
    var bt = {
            ...
            addAnimation: function (t, e, i, n) {
                var a,
                    ...
                    r = this.animations;
                for (
                    e.chart = t, e.startTime = Date.now(), e.duration = i, n || (t.animating = !0), a = 0, o = r.length;
                    a < o;
                    ++a
                )
            ...
            advance: function () {
                for (var t, e, i, n, a = this.animations, o = 0; o < a.length; )
                    (e = (t = a[o]).chart),
                        ...
                        t.currentStep >= i
                            ? (ut.callback(t.onAnimationComplete, [t], e), (e.animating = !1), a.splice(o, 1))
                            : ++o;
            },
        },
        ...
        setHoverStyle: function (t) {
            ...
            (t.$previousStyle = {
                ...
                (a.backgroundColor = xt(
                    [n.hoverBackgroundColor, e.hoverBackgroundColor, o(a.backgroundColor)],
                    void 0,
                    i
                )),
    ...
    function zt(t, e, i) {
        ...
        return (
            ut.isObject(s)
                ? ((n = +s.top || 0), (a = +s.right || 0), (o = +s.bottom || 0), (r = +s.left || 0))
                : (n = a = o = r = +s || 0),
            {
    ...
    st._set('global', {
        elements: { rectangle: { backgroundColor: Ft, borderColor: Ft, borderSkipped: 'bottom', borderWidth: 0 } },
    });
    var Nt = pt.extend({
            draw: function () {
            ...
            getCenterPoint: function () {
                var t,
                    ...
                    i = this._view;
                return (
                    Lt(i) ? ((t = i.x), (e = (i.y + i.base) / 2)) : ((t = (i.x + i.base) / 2), (e = i.y)),
                    { x: t, y: e }
                );
            },
            getArea: function () {
    ...
    var $t = Mt.extend({
        ...
        updateElement: function (t, e, i) {
            var n = this,
                ...
                f =
                    i && s.animateRotate
                        ...
                        : t.hidden
                        ? 0
                        : n.calculateCircumference(c.data[e]) * (r.circumference / (2 * Math.PI)),
            ...
            var v = t._model;
            (i && s.animateRotate) ||
                ((v.startAngle = 0 === e ? r.rotation : n.getMeta().data[e - 1]._model.endAngle),
                    ...
                    for (t = 0, e = l.length; t < e; ++t)
                        (i = l[t]._model),
                            ee(i, s) &&
                                ...
                                t < l.length - 1 &&
                                    ee(l[t + 1]._model, s) &&
                                    ((i.controlPointNextX = d(i.controlPointNextX, s.left, s.right)),
                                    (i.controlPointNextY = d(i.controlPointNextY, s.top, s.bottom))));
            },
            draw: function () {
                var t,
                    e = this.chart,
                        ...
                        (b = (function (t, e, i, n) {
                            ...
                            return (
                                'right' === d
                                    ? (a -= e.width)
                                    : 'center' === d &&
                                      ((a -= e.width / 2) + e.width > n.width && (a = n.width - e.width),
                                      a < 0 && (a = 0)),
                            ...
                            (v = (function (t, e) {
                                ...
                                'center' === h
                                    ...
                                    i(s.x)
                                        ...
                                        : n(s.x) && ((u = 'right'), o(s.x) && ((u = 'center'), (h = r(s.y))));
                                var g = t._options;
            ...
            return (
                ut.each(
                    ...
                    function (i, n) {
                        ...
                        if (
                            (a.type && a.type !== o && (t.destroyDatasetMeta(n), (a = t.getDatasetMeta(n))),
                            (a.type = o),
                            a.controller)
                        )
    ...
    var fi = pt.extend({
            ...
            fit: function () {
                ...
                if (a.display && s) {
                    ...
                    if (((t._maxLabelLines = v), (t.longestLabelWidth = m), d)) {
                        ...
                        0 !== t.labelRotation
                            ? ((M = 'bottom' === l ? k * C : k * b), (_ = 'bottom' === l ? k * b : k * S))
                            : ((M = C / 2), (_ = S / 2)),
            ...
            _autoSkip: function (t) {
                var e,
                    ...
                    h = [];
                for (
                    d > u && (s = 1 + Math.floor(d / u)), r > l && (s = Math.max(s, 1 + Math.floor(r / l))), e = 0;
                    e < r;
                    e++
                )
            ...
            _isVisible: function () {
                ...
                for (t = 0, e = n.data.datasets.length; t < e; ++t)
                    if (
                        ...
                        ((i = n.getDatasetMeta(t)).xAxisID === this.id || i.yAxisID === this.id)
                    )
                        return !0;
                return !1;
            },
                    ...
                    if (
                        ...
                        if (m)
                            (R = e.left + (e.right - e.left) / 2),
                                (O = 'bottom' === f ? e.bottom - B - A.bottom : e.top + B + A.top);
                        else {
                            var N = 'left' === f;
                        ...
                        i.isDatasetVisible(a) &&
                            ...
                            ut.each(n.data, function (i, n) {
                                ...
                                isNaN(a) ||
                                    ...
                                    ((d[n] = d[n] || 0),
                                    (u[n] = u[n] || 0),
                                    e.relativePoints ? (d[n] = 100) : a < 0 ? (u[n] += a) : (d[n] += a));
                            });
                    }),
    ...
    var Ci = fi.extend({
            ...
            getPixelForValue: function (t) {
                ...
                return (
                    ...
                    t !== n &&
                        (0 === n && ((e -= h = wi(s.fontSize, st.global.defaultFontSize)), (n = u)),
                        ...
                        (function (t) {
                            ...
                            e.save(),
                                ...
                                e.setLineDash &&
                                    ...
                                    (e.lineDashOffset = Ai([n.borderDashOffset, a.borderDashOffset, 0])));
        ...
        for (
            u ||
                ...
                c &&
                    ...
                    !h &&
                    !s.round &&
                    ((a = +o.startOf(a, d)), (a = +o.add(a, ~~((g - a) / (f.size * u)) * u, l)));
            a < p;
            a = +o.add(a, u, l)
        )
            m.push(+a);
    ...
    var Ji = fi.extend({
            ...
            buildTicks: function () {
                ...
                for (
                    'ticks' === r.bounds && l.length && ((a = l[0]), (o = l[l.length - 1])),
                        a = Gi(n, s.min) || a,
                        o = Gi(n, s.max) || o,
                        t = 0,
                        e = l.length;
                ...
                return (
                    ...
                    (n._offsets = (function (t, e, i, n, a) {
                        ...
                        return (
                            a.offset &&
                                ...
                                (a.time.min ||
                                    ((o = Xi(t, 'time', e[0], 'pos')),
                                    (s = 1 === e.length ? 1 - o : (Xi(t, 'time', e[1], 'pos') - o) / 2)),
                                a.time.max ||
                                    ((r = Xi(t, 'time', e[e.length - 1], 'pos')),
                                    (l = 1 === e.length ? r : (r - Xi(t, 'time', e[e.length - 2], 'pos')) / 2))),
                            { start: s, end: l }
                        );
                    })(n._table, d, 0, 0, r)),
                    ...
                    (function (t, e, i) {
                        ...
                        for (n = 0, a = e.length; n < a; ++n)
                            (o = e[n]), (r = !!i && o === +t._adapter.startOf(o, i)), s.push({ value: o, major: r });
                        return s;
                    })(n, d, n._majorUnit)
                );
            },
    ...
    si._date.override(
        'function' == typeof t
            ? {
                  ...
                  parse: function (e, i) {
                      return (
                          'string' == typeof e && 'string' == typeof i ? (e = t(e, i)) : e instanceof t || (e = t(e)),
                    ...
                    (a.textAlign = 'left'),
                        ...
                        ut.each(t.legendItems, function (t, e) {
                            ...
                            (0 === e || u[u.length - 1] + n + i.padding > l.width) &&
                                ((h += r + i.padding), (u[u.length - (e > 0 ? 0 : 1)] = i.padding)),
        ...
        draw: function () {
            ...
            if (e.display) {
                ...
                var f = fn(i, c),
                    ...
                    p = t.isHorizontal();
                l = p
                    ? { x: t.left + (r - s[0]) / 2 + i.padding, y: t.top + i.padding, line: 0 }
                ...
                ut.each(t.legendItems, function (n, u) {
                    ...
                    p
                        ? u > 0 &&
                          ...
                          ((x = l.y += m), l.line++, (b = l.x = t.left + (r - s[l.line]) / 2 + i.padding))
                        : u > 0 &&
                          x + m > t.top + t.minSize.height &&
                          ((b = l.x = b + t.columnWidths[l.line] + i.padding), (x = l.y = t.top + i.padding), l.line++),
                        (function (t, i, n) {
                            if (!(isNaN(f) || f <= 0)) {
                                d.save();
                        ...
                        (function (t, e, i, n) {
                            ...
                            d.fillText(i.text, o, r),
                                i.hidden &&
                                    (d.beginPath(), (d.lineWidth = 2), d.moveTo(o, r), d.lineTo(o + n, r), d.stroke());
                        })(b, x, n, h),
    ...
    var mn = {
            ...
            beforeUpdate: function (t) {
                var e = t.options.legend,
                    i = t.legend;
                e
                    ? (ut.mergeIf(e, st.global.legend), i ? (ke.configure(t, i, e), (i.options = e)) : pn(t, e))
    ...
    var bn = pt.extend({
        ...
        fit: function () {
            ...
            t.isHorizontal() ? ((n.width = t.maxWidth), (n.height = r)) : ((n.width = r), (n.height = t.maxHeight)),
                (t.width = n.width),
                (t.height = n.height);
        },
        afterFit: vn,
        ...
        Mn = {
            ...
            beforeUpdate: function (t) {
                var e = t.options.title,
                    i = t.titleBlock;
                e
                    ? (ut.mergeIf(e, st.global.title), i ? (ke.configure(t, i, e), (i.options = e)) : xn(t, e))
                            ...
                            (ut.almostEquals(n.deltaK, 0, this.EPSILON)
                                ...
                                : ((o = n.mK / n.deltaK),
                                  ...
                                  (l = Math.pow(o, 2) + Math.pow(r, 2)) <= 9 ||
                                      ((s = 3 / Math.sqrt(l)), (n.mK = o * s * n.deltaK), (a.mK = r * s * n.deltaK))));
                for (e = 0; e < h; ++e)
                    (n = u[e]).model.skip ||
                        ((i = e > 0 ? u[e - 1] : null),
                        (a = e < h - 1 ? u[e + 1] : null),
