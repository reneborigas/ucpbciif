 ...
 */ angular.module(
        ...
        function (a, b, c, d) {
            ...
            return {
                link: function (d, f, g) {
                                ...
                                f
                                    ...
                                    e
                                        ? e(f, {
                                              ...
                                              .start()
                                              ['finally'](k)
                                        : a.addClass(f, 'in', { css: { overflow: 'hidden' }, to: i(f[0]) }).then(k);
                            }, angular.noop);
                    }
                    function k() {
                    ...
                    function l() {
                        return f.hasClass('collapse') || f.hasClass('in')
                            ? void b.resolve(p(d)).then(function () {
                                  f
                                      ...
                                      .attr('aria-hidden', !0),
                                      e
                                          ? e(f, { removeClass: 'in', to: t }).start()['finally'](m)
                                          : a.removeClass(f, 'in', { to: t }).then(m);
                              }, angular.noop)
                            : m();
                    }
                    function m() {
            ...
            return {
                ...
                link: function (a, b, c, d) {
                    b.addClass('panel'),
                        ...
                        (a.panelClass = c.panelClass || 'panel-default'),
                ...
                function g(c, d, g) {
                    if (!s) {
                        if (
                            ...
                            angular.isNumber(h) && p[h].element && p[h].element.data(q, c.direction),
                ...
                b.addClass('carousel'),
                    (o.addSlide = function (b, c) {
                        p.push({ slide: b, element: c }),
                            ...
                            (b.index === a.active || (1 === p.length && !angular.isNumber(a.active))) &&
                    ...
                    (o.removeSlide = function (b) {
                        ...
                        p.splice(c, 1),
                            p.length > 0 && r === c
                                ? c >= p.length
                                    ? ((r = p.length - 1), (a.active = r), f(r), o.select(p[p.length - 1]))
            ...
            function h(a) {
                for (var b, c, d = [], e = 0; e < a.length; )
                    if (angular.isNumber(c)) {
                        if ("'" === a.charAt(e))
                            (e + 1 >= a.length || "'" !== a.charAt(e + 1)) && (d.push(i(a, c, e)), (c = null));
                        else if (e === a.length) for (; c < a.length; ) (b = j(a, c)), d.push(b), (c = b.endIdx);
                        e++;
                            ...
                            k(m.year, m.month, m.date) &&
                                (!angular.isDate(e) || isNaN(e.getTime()) || l
                                    ? ((n = new Date(0)),
                                      ...
                                      u.call(n, m.hours || 0, m.minutes || 0, m.seconds || 0, m.milliseconds || 0))
                                    : ((n = new Date(e)),
                                      s.call(n, m.year, m.month, m.date),
                        ...
                        if (!h) {
                            var i = function (b) {
                                ...
                                j.some(function (a) {
                                    ...
                                    h.lastActivated !== c &&
                                        (h.lastActivated && a.removeClass(h.lastActivated.element, f),
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l) {
                ...
                function n(b) {
                    ...
                    if (angular.version.minor < 6)
                        (c = b.$options || a.datepickerOptions.ngModelOptions || i.ngModelOptions || {}),
                        ...
                        var d =
                            ...
                            (a.datepickerOptions.ngModelOptions ? a.datepickerOptions.ngModelOptions.timezone : null) ||
                ...
                b.addClass('uib-datepicker'),
                    ...
                    [
                        ...
                        switch (b) {
                            ...
                            case 'dateDisabled':
                                ...
                                break;
                            case 'datepickerMode':
                                a.datepickerMode = angular.isDefined(a.datepickerOptions.datepickerMode)
                            ...
                            case 'startingDay':
                                angular.isDefined(a.datepickerOptions.startingDay)
                                    ...
                                    : (o.startingDay = (f.DATETIME_FORMATS.FIRSTDAYOFWEEK + 8) % 7);
                                break;
                            case 'maxDate':
                            case 'minDate':
                                a.$watch('datepickerOptions.' + b, function (a) {
                                    a
                                        ? angular.isDate(a)
                                            ? (o[b] = l.fromTimezone(new Date(a), q.getOption('timezone')))
                                            : (j &&
                                                  g.warn(
                                        ...
                                        : (o[b] = i[b]
                                              ? l.fromTimezone(new Date(i[b]), q.getOption('timezone'))
                                              : null),
                                        o.refreshView();
                                });
                                break;
                            ...
                            case 'minMode':
                                a.datepickerOptions[b]
                                    ? a.$watch(
                                          ...
                                          function (c) {
                                              (o[b] = a[b] = angular.isDefined(c) ? c : a.datepickerOptions[b]),
                                                  (('minMode' === b &&
                                                      o.modes.indexOf(a.datepickerOptions.datepickerMode) <
                                                          o.modes.indexOf(o[b])) ||
                                                      ('maxMode' === b &&
                                                          o.modes.indexOf(a.datepickerOptions.datepickerMode) >
                                                              o.modes.indexOf(o[b]))) &&
                    ...
                    (this.init = function (b) {
                        (p = b),
                            ...
                            a.datepickerOptions.initDate
                                ? ((o.activeDate =
                                      l.fromTimezone(a.datepickerOptions.initDate, q.getOption('timezone')) ||
                                      new Date()),
                                  a.$watch('datepickerOptions.initDate', function (a) {
                                      a &&
                                          (p.$isEmpty(p.$modelValue) || p.$invalid) &&
                                          ((o.activeDate = l.fromTimezone(a, q.getOption('timezone'))),
                                          o.refreshView());
                                  }))
                    ...
                    (this.render = function () {
                        if (p.$viewValue) {
                            ...
                            b
                                ...
                                : k || g.error('Datepicker directive: "ng-model" value must be a Date object');
                        }
                        this.refreshView();
                    }),
                    (this.refreshView = function () {
                        if (this.element) {
                            ...
                            (b = l.fromTimezone(b, q.getOption('timezone'))),
                                p.$setValidity('dateDisabled', !b || (this.element && !this.isDisabled(b)));
                        }
                    }),
                    (this.createDateObject = function (b, c) {
                        ...
                        return (
                            ...
                            o.activeDate && 0 === this.compare(g.date, o.activeDate) && (a.activeDt = g),
                            g
                        );
                    }),
                    (this.isDisabled = function (b) {
                        return (
                            ...
                            (a.dateDisabled && a.dateDisabled({ date: b, mode: a.datepickerMode }))
                        );
                    }),
                    ...
                    (a.select = function (b) {
                        if (a.datepickerMode === o.minMode) {
                            var c = p.$viewValue
                                ? l.fromTimezone(new Date(p.$viewValue), q.getOption('timezone'))
                    ...
                    (a.toggleMode = function (b) {
                        (b = b || 1),
                            (a.datepickerMode === o.maxMode && 1 === b) ||
                                (a.datepickerMode === o.minMode && -1 === b) ||
                                (m(o.modes[o.modes.indexOf(a.datepickerMode) + b]), a.$emit('uib:datepicker.mode'));
                    }),
                    (a.keys = {
                        13: 'enter',
                        32: 'space',
                ...
                (this.step = { months: 1 }),
                    ...
                    (this.handleKeyDown = function (a, b) {
                        ...
                        if ('left' === a) c -= 1;
                            ...
                            'home' === a
                                ? (c = 1)
                                : 'end' === a && (c = d(this.activeDate.getFullYear(), this.activeDate.getMonth()));
                ...
                (this.step = { years: 1 }),
                    ...
                    (this._refreshView = function () {
                        ...
                        (a.title = c(this.activeDate, this.formatMonthTitle)),
                            ...
                            (a.yearHeaderColspan = this.monthColumns > 3 ? this.monthColumns - 2 : 1);
                    }),
                    (this.compare = function (a, b) {
                ...
                (this.element = b),
                    ...
                    (this._refreshView = function () {
                        for (var b, c = new Array(f), g = 0, h = d(this.activeDate.getFullYear()); f > g; g++)
                            (b = new Date(this.activeDate)),
                                ...
                                (c[g] = angular.extend(this.createDateObject(b, this.formatYear), {
                                    uid: a.uniqueId + '-' + g,
                                }));
                    ...
                    (this.handleKeyDown = function (a, b) {
                        ...
                        'left' === a
                            ...
                            : 'end' === a && (c = d(this.activeDate.getFullYear()) + f - 1),
            ...
            return {
                ...
                positionElements: function (a, c, d, e) {
                        ...
                        var k = this.viewportOffset(a, e),
                            ...
                            m = {
                                width:
                                    g +
                                    Math.round(
                                        Math.abs(this.parseStyle(l.marginLeft) + this.parseStyle(l.marginRight))
                                    ),
                                height:
                                    h +
                                    Math.round(
                                        Math.abs(this.parseStyle(l.marginTop) + this.parseStyle(l.marginBottom))
                                    ),
                            };
                        if (
                            ((d[0] =
                                'top' === d[0] && m.height > k.top && m.height <= k.bottom
                                    ? 'bottom'
                                    : 'bottom' === d[0] && m.height > k.bottom && m.height <= k.top
                                    ? 'top'
                                    : 'left' === d[0] && m.width > k.left && m.width <= k.right
                                    ? 'right'
                                    : 'right' === d[0] && m.width > k.right && m.width <= k.left
                                    ? 'left'
                                    : d[0]),
                            (d[1] =
                                'top' === d[1] && m.height - i.height > k.bottom && m.height - i.height <= k.top
                                    ? 'bottom'
                                    : 'bottom' === d[1] &&
                                      m.height - i.height > k.top &&
                                      m.height - i.height <= k.bottom
                                    ? 'top'
                                    : 'left' === d[1] && m.width - i.width > k.right && m.width - i.width <= k.left
                                    ? 'right'
                                    : 'right' === d[1] && m.width - i.width > k.left && m.width - i.width <= k.right
                                    ? 'left'
                                    : d[1]),
                            'center' === d[1])
                        )
                            if (f.vertical.test(d[0])) {
                                ...
                                k.left + n < 0 && m.width - i.width <= k.right
                                    ? (d[1] = 'left')
                                    : k.right + n < 0 && m.width - i.width <= k.left && (d[1] = 'right');
                            } else {
                                var o = i.height / 2 - m.height / 2;
                                k.top + o < 0 && m.height - i.height <= k.bottom
                                    ? (d[1] = 'top')
                                    : k.bottom + o < 0 && m.height - i.height <= k.top && (d[1] = 'bottom');
                            }
                    }
                    switch (d[0]) {
                        case 'top':
                    ...
                    switch (d[1]) {
                        ...
                        case 'center':
                            f.vertical.test(d[0])
                                ? (j.left = i.left + i.width / 2 - g / 2)
                                : (j.top = i.top + i.height / 2 - h / 2);
                    }
                    return (
                        (j.top = Math.round(j.top)),
                        (j.left = Math.round(j.left)),
                        (j.placement = 'center' === d[1] ? d[0] : d[0] + '-' + d[1]),
                        j
                    );
                },
        ...
        .controller('UibDatepickerPopupController', [
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
                function q(b) {
                    ...
                    if (isNaN(c))
                        for (var d = 0; d < J.length; d++) if (((c = l.parse(b, J[d], a.date)), !isNaN(c))) return c;
                    return c;
                }
                function r(a) {
                ...
                function s(a, b) {
                    var d = a || b;
                    return c.ngRequired || d
                        ? (angular.isNumber(d) && (d = new Date(d)),
                          d ? (angular.isDate(d) && !isNaN(d) ? !0 : angular.isString(d) ? !isNaN(q(d)) : !1) : !0)
                        : !0;
                }
                function t(c) {
                ...
                function w(a) {
                    ...
                    return (
                        angular.version.minor < 6
                            ? ((b = angular.isObject(a.$options) ? a.$options : { timezone: null }),
                ...
                (this.init = function (e) {
                    if (
                        ...
                        (z = angular.isDefined(c.datepickerAppendToBody)
                            ...
                            : m.appendToBody),
                        (A = angular.isDefined(c.onOpenFocus) ? a.$parent.$eval(c.onOpenFocus) : m.onOpenFocus),
                    ...
                    (D = angular.element('<div uib-datepicker-popup-wrap><div uib-datepicker></div></div>')),
                        D.attr({ 'ng-model': 'date', 'ng-change': 'dateSelection(date)', 'template-url': B }),
                        (E = angular.element(D.children()[0])),
                        E.attr('template-url', C),
                        a.datepickerOptions || (a.datepickerOptions = {}),
                        K &&
                            'month' === c.type &&
                            ((a.datepickerOptions.datepickerMode = 'month'), (a.datepickerOptions.minMode = 'month')),
                    ...
                    (a.isDisabled = function (b) {
                        ...
                        return (
                            ...
                            (a.datepickerOptions && c.minDate && a.compare(b, c.minDate) < 0) ||
                    ...
                    (a.select = function (b, c) {
                        if ((c.stopPropagation(), 'today' === b)) {
                            ...
                            angular.isDate(a.date)
                                ? ((b = new Date(a.date)), b.setFullYear(d.getFullYear(), d.getMonth(), d.getDate()))
                                : ((b = l.fromTimezone(d, H.getOption('timezone'))), b.setHours(0, 0, 0, 0));
                        }
                        a.dateSelection(b);
                    }),
                    (a.close = function (c) {
                    ...
                    a.$watch('isOpen', function (d) {
                        d
                                ...
                                : n(
                                      function () {
                                          ...
                                          z || j.parsePlacement(d)[2]
                                              ? ((F = F || angular.element(j.scrollParent(b))), F && F.on('scroll', v))
                                              : (F = null),
                            ...
                            : (h.off('click', t), F && F.off('scroll', v), angular.element(g).off('resize', v));
                    }),
    ...
    angular
        ...
        .constant('uibDropdownConfig', { appendToOpenClass: 'uib-dropdown-open', openClass: 'open' })
                ...
                var f = function (a) {
                    if (d && d.isOpen && !((a && 'disabled' === d.getAutoClose()) || (a && 3 === a.which))) {
                        ...
                        if (!(a && c && c[0].contains(a.target))) {
                            ...
                            (a && 'outsideClick' === d.getAutoClose() && e && e[0].contains(a.target)) ||
                                (d.focusToggleElement(), (d.isOpen = !1), b.$$phase || d.$apply());
                        }
                    }
                };
                    ...
                    if (d) {
                        ...
                        27 === a.which
                            ...
                            : d.isKeynavEnabled() &&
                              ...
                              d.isOpen &&
                              (e || g) &&
                              (a.preventDefault(), a.stopPropagation(), d.focusDropdownEntry(a.which));
                    }
                };
            },
        ])
                ...
                b.addClass('dropdown'),
                    ...
                    (p.focusDropdownEntry = function (a) {
                        var c = o.dropdownMenu
                            ? angular.element(o.dropdownMenu).find('a')
                            : b.find('ul').eq(0).find('a');
                        switch (a) {
                            case 40:
                                angular.isNumber(o.selectedOption)
                                    ? (o.selectedOption =
                                          o.selectedOption === c.length - 1 ? o.selectedOption : o.selectedOption + 1)
                                    : (o.selectedOption = 0);
                                break;
                            case 38:
                                angular.isNumber(o.selectedOption)
                                    ? (o.selectedOption = 0 === o.selectedOption ? 0 : o.selectedOption - 1)
                    ...
                    p.$watch('isOpen', function (e, n) {
                        ...
                        if (
                            ...
                            u &&
                                o.dropdownMenu &&
                                (e ? (u.append(o.dropdownMenu), b.on('$destroy', l)) : (b.off('$destroy', l), l())),
                            u && o.dropdownMenu)
                        ) {
                            var z,
                                A,
                            ...
                            if (
                                ...
                                A
                                    ? ((z.left = 'auto'),
                                      ...
                                      B.heightOverflow && B.scrollbarWidth && (D = B.scrollbarWidth),
                                      (z.right = window.innerWidth - D - (C.left + b.prop('offsetWidth')) + 'px'))
                                ...
                                (z.top = C.top - E.top + 'px'),
                                    A
                                        ? (z.right =
                                              window.innerWidth - (C.left - E.left + b.prop('offsetWidth')) + 'px')
                        ...
                        if (H === !e) {
                            var J;
                            (J = u ? (I ? 'removeClass' : 'addClass') : e ? 'addClass' : 'removeClass'),
                        ...
                        f.addClass(g.windowTopClass || ''),
                            ...
                            (e.close = function (b) {
                                ...
                                c &&
                                    ...
                                    (b.preventDefault(), b.stopPropagation(), a.dismiss(c.key, 'backdrop click'));
                            }),
                            f.on('click', e.close),
                            (e.$isRendered = !0);
                        var h = b.defer();
                        ...
                        switch (a.which) {
                            ...
                            case 9:
                                ...
                                a.shiftKey
                                    ...
                                    : z.isFocusInLastItem(a, c) && (d = z.focusFirstFocusableElement(c)),
                ...
                return (
                    ...
                    (z.open = function (b, f) {
                        ...
                        o >= 0 &&
                            ...
                            (u.modalOptions = f),
                            (u.index = o),
                            (t = angular.element('<div uib-modal-backdrop="modal-backdrop"></div>')),
                            t.attr({
                            ...
                            i.isScrollable(m) &&
                                ...
                                v.heightOverflow && v.scrollbarWidth && m.css({ paddingRight: v.right + 'px' })));
                        var p;
                        f.component
                ...
                $get: [
                    ...
                    function (b, c, d, e, f, g, h) {
                        function i(a) {
                            return a.template
                                ? c.when(a.template)
                                : e(angular.isFunction(a.templateUrl) ? a.templateUrl() : a.templateUrl);
                        }
                        var j = {},
                            k = null;
                        return (
                                        ...
                                        .then(
                                            function (a) {
                                                ...
                                                var i,
                                                    ...
                                                    r = {};
                                                e.component
                                                    ? (c(q, !1, !0, !1), (q.name = e.component), (k.component = q))
                                                    : e.controller &&
                                                      (c(r, !0, !1, !0),
                                                      ...
                                                      e.controllerAs &&
                                                          ...
                                                          (i.$close = g.$close),
                                                          (i.$dismiss = g.$dismiss),
                                                          angular.extend(i, { $resolve: r.$scope.$resolve }, d)),
                                                      (i = j()),
                    ...
                    (b.setNumPages = d.numPages ? a(d.numPages).assign : angular.noop),
                        ...
                        (b.updatePage = function () {
                            b.setNumPages(c.$parent, c.totalPages),
                                c.page > c.totalPages ? c.selectPage(c.totalPages) : b.ngModelCtrl.$render();
                        }),
    ...
    angular
        ...
        .constant('uibPagerConfig', { itemsPerPage: 10, previousText: '« Previous', nextText: 'Next »', align: !0 })
        .directive('uibPager', [
            'uibPagerConfig',
            function (a) {
                return {
                    ...
                    g &&
                        (j
                            ? ((d = Math.max(a - Math.floor(i / 2), 1)),
                              (e = d + i - 1),
                              e > b && ((e = b), (d = e - i + 1)))
                            : ((d = (Math.ceil(a / i) - 1) * i + 1), (e = Math.min(d + i - 1, b))));
                    for (var h = d; e >= h; h++) {
                        var n = f(h, m(h), h === a);
                        c.push(n);
                    }
                                ...
                                return {
                                    compile: function (a, b) {
                                        ...
                                        return function (a, b, d, f) {
                                            ...
                                            function m() {
                                                (O && !a.$eval(d[k + 'Enable'])) ||
                                                    (u(), x(), P.popupDelay ? H || (H = g(r, P.popupDelay, !1)) : r());
                                            }
                                            function q() {
                                            ...
                                            function x() {
                                                ...
                                                (P.popupDelay = isNaN(c) ? n.popupDelay : c),
                                                    (P.popupCloseDelay = isNaN(f) ? n.popupCloseDelay : f);
                                            }
                                            function y(b) {
                                            ...
                                            function B(a) {
                                                P &&
                                                    P.isOpen &&
                                                    E &&
                                                    (b[0].contains(a.target) || E[0].contains(a.target) || q());
                                            }
                                            function C(a) {
                                                27 === a.which && q();
                                            }
                                                            ...
                                                            (J = g(
                                                                function () {
                                                                    var a = i.positionElements(b, E, P.placement, M),
                                                                        c = angular.isDefined(E.offsetHeight)
                                                                            ? E.offsetHeight
                                                                            : E.prop('offsetHeight'),
                                                                    ...
                                                                    E.hasClass(e[0]) ||
                                                                        ...
                                                                        E.addClass(e[0])),
                                                                        E.hasClass(
                                                                            n.placementClassPrefix + a.placement
                                                                        ) ||
                                                                            (E.removeClass(n.placementClassPrefix + L),
                                                                            E.addClass(
                                                                                n.placementClassPrefix + a.placement
                                                                            )),
                                                                        (K = g(
                                                                            function () {
                                                                                var a = angular.isDefined(
                                                                                        E.offsetHeight
                                                                                    )
                                                                                        ? E.offsetHeight
                                                                                        : E.prop('offsetHeight'),
                                            ...
                                            var X,
                                                Y = k + 'AppendToBody';
                                            (X = Y in d && void 0 === d[Y] ? !0 : a.$eval(d[Y])),
            ...
            function (a, b, c) {
                ...
                (this.init = function (e) {
                    ...
                    var g = angular.isDefined(b.ratingStates)
                        ...
                        : new Array(angular.isDefined(b.max) ? a.$parent.$eval(b.max) : c.max);
                    ...
                    (this.buildTemplateObjects = function (a) {
                        for (var b = 0, c = a.length; c > b; b++)
                            a[b] = angular.extend(
                                { index: b },
                                { stateOn: this.stateOn, stateOff: this.stateOff, title: this.getTitle(b) },
                                a[b]
                            );
                        return a;
                    }),
                    ...
                    (d.select = function (a, f) {
                        if (!e) {
                            var g = b(c),
                                h = d.tabs[g];
                            if (h) {
                                if ((h.tab.onDeselect({ $event: f, $selectedIndex: a }), f && f.isDefaultPrevented()))
                                    return;
                                h.tab.active = !1;
                            }
                            var i = d.tabs[a];
        ...
        .controller('UibTimepickerController', [
            ...
            function (a, b, c, d, e, f, g) {
                function h() {
                    ...
                    return c && '' !== a.hours
                        ? (a.showMeridian && (12 === b && (b = 0), a.meridian === y[1] && (b += 12)), b)
                        : void 0;
                }
                function i() {
                    var b = +a.minutes,
                ...
                function r() {
                    return (
                        ...
                        (!a.showSeconds || (a.showSeconds && (null === a.seconds || '' === a.seconds)))
                    );
                }
                var s,
                    t,
                ...
                c.secondStep &&
                        ...
                        b.on('keydown', function (b) {
                            E ||
                                (38 === b.which
                                    ...
                                    : 40 === b.which && (b.preventDefault(), a.decrementHours(), a.$apply()));
                        }),
                            c.on('keydown', function (b) {
                                E ||
                                    (38 === b.which
                                        ? (b.preventDefault(), a.incrementMinutes(), a.$apply())
                                        : 40 === b.which && (b.preventDefault(), a.decrementMinutes(), a.$apply()));
                            }),
                            d.on('keydown', function (b) {
                                E ||
                                    (38 === b.which
                                        ? (b.preventDefault(), a.incrementSeconds(), a.$apply())
                                        : 40 === b.which && (b.preventDefault(), a.decrementSeconds(), a.$apply()));
                            });
                    }),
                    (this.setupInputEvents = function (b, c, d) {
                        ...
                        var e = function (b, c, d) {
                            x.$setViewValue(null),
                                ...
                                angular.isDefined(b) && ((a.invalidHours = b), s && s.$setValidity('hours', !1)),
                                angular.isDefined(c) && ((a.invalidMinutes = c), t && t.$setValidity('minutes', !1)),
                                angular.isDefined(d) && ((a.invalidSeconds = d), u && u.$setValidity('seconds', !1));
                        };
                        (a.updateHours = function () {
                            ...
                            x.$setDirty(),
                                angular.isDefined(a) && angular.isDefined(b)
                                    ? (v.setHours(a), v.setMinutes(b), C > v || v > D ? e(!0) : l('h'))
                                    : e(!0);
                        }),
                            ...
                            (a.updateMinutes = function () {
                                ...
                                x.$setDirty(),
                                    angular.isDefined(a) && angular.isDefined(b)
                                        ? (v.setHours(b), v.setMinutes(a), C > v || v > D ? e(void 0, !0) : l('m'))
                                        : e(void 0, !0);
                            }),
                    ...
                    (this.render = function () {
                        ...
                        isNaN(b)
                            ...
                            : (b && (v = b),
                              C > v || v > D
                                  ? (x.$setValidity('time', !1), (a.invalidHours = !0), (a.invalidMinutes = !0))
                                  : m(),
                              n());
                    }),
        ...
        .controller('UibTypeaheadController', [
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                ...
                K &&
                    ...
                    b.css({ position: 'relative', 'vertical-align': 'top', 'background-color': 'transparent' }),
                ...
                U.attr({
                    ...
                    angular.isDefined(c.typeaheadTemplateUrl) && U.attr('template-url', c.typeaheadTemplateUrl),
                ...
                W(),
                    ...
                    (P.select = function (d, e) {
                        ...
                        (y = !0),
                            ...
                            B(a, { $item: h, $model: f, $label: O.viewMapper(a, i), $event: e }),
                            W(),
                    ...
                    b.on('keydown', function (b) {
                        if (0 !== P.matches.length && -1 !== s.indexOf(b.which)) {
                            var c = A(a, { $event: b });
                            if ((-1 === P.activeIdx && c) || (9 === b.which && b.shiftKey))
                            ...
                            switch (b.which) {
                                case 27:
                                    ...
                                    break;
                                case 38:
                                    (P.activeIdx = (P.activeIdx > 0 ? P.activeIdx : P.matches.length) - 1),
                                        P.$digest(),
                                        (d = U[0].querySelectorAll('.uib-typeahead-match')[P.activeIdx]),
                                ...
                                default:
                                    c &&
                                        P.$apply(function () {
                                            angular.isNumber(P.debounceUpdate) || angular.isObject(P.debounceUpdate)
                                                ? k(
                                                      function () {
                    ...
                    b.on('blur', function (a) {
                        C &&
                            ...
                            ((y = !0),
                            P.$apply(function () {
                                angular.isObject(P.debounceUpdate) && angular.isNumber(P.debounceUpdate.blur)
                                    ? k(function () {
                ...
                h.on('click', ca),
                    a.$on('$destroy', function () {
                        h.off('click', ca),
                            (F || G) && da.remove(),
                            F && (angular.element(i).off('resize', n), h.find('body').off('scroll', n)),
                            U.remove(),
                            K && S.remove();
                    });
                var da = d(U)(P);
                F ? h.find('body').append(da) : G ? angular.element(G).eq(0).append(da) : b.after(da),
                    (this.init = function (b) {
                        (q = b),
                            (r = p(q)),
        ...
        .filter('uibTypeaheadHighlight', [
            ...
            function (a, b, c) {
                ...
                return (
                    ...
                    function (b, g) {
                        return (
                            !f && e(b) && c.warn('Unsafe use of typeahead please use ngSanitize'),
