...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function g(l) {
        ((!l.__d && (l.__d = !0) && u.push(l) && !i++) || r !== n.debounceRendering) &&
            ...
            (l.__k = x(l.__k, function (u) {
                if (null != u) {
                    ...
                    if (
                        ...
                        (h = u.ref) &&
                            p.ref != h &&
                            (k || (k = []), p.ref && k.push(p.ref, null, u), k.push(h, u.__c || y, u)),
                        null != y)
                    ) {
                        var c;
    ...
    function C(n, l, u) {
        '-' === l[0]
            ? n.setProperty(l, u)
            : (n[l] = 'number' == typeof u && !1 === s.test(l) ? u + 'px' : null == u ? '' : u);
    }
        ...
        if ((t ? 'className' === l && (l = 'class') : 'class' === l && (l = 'className'), 'style' === l))
            ...
            'o' === l[0] && 'n' === l[1]
                ? ((o = l !== (l = l.replace(/Capture$/, ''))),
                  ...
                  u ? (i || n.addEventListener(l, z, o), ((n.l || (n.l = {}))[l] = u)) : n.removeEventListener(l, z, o))
                ...
                if (
                    ...
                    i.__c
                        ...
                        : ('prototype' in P && P.prototype.render
                              ? (u.__c = v = new P(g, x))
                              : ((u.__c = v = new m(g, x)), (v.constructor = P), (v.render = E)),
                          _ && _.sub(v),
                          (v.props = g),
                          v.state || (v.state = {}),
                          (v.context = x),
                    ...
                    null != P.getDerivedStateFromProps &&
                        (v.__s == v.state && (v.__s = a({}, v.__s)), a(v.__s, P.getDerivedStateFromProps(g, v.__s))),
                    (p = v.props),
                    (y = v.state),
                    h)
                )
    ...
    function $(n, l, u, i, t, r, o, f) {
        ...
        if (null === l.type) y !== d && n.data != d && (n.data = d);
            ...
            P(n, d, y, t, f),
                h
                    ? (l.__k = [])
                    : ((l.__k = l.props.children), b(n, l, u, i, 'foreignObject' !== l.type && t, r, o, e, f)),
                f ||
            ...
            return formatter.format(
                {
                    marker: marker,
                    timeZoneOffset:
                        dateOptions.forcedTzo != null ? dateOptions.forcedTzo : this.offsetForMarker(marker),
                },
                this
            );
        };
    ...
    */
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        var subjectConfigs = compileEventUis(
            subjectDefs,
            interaction.isEvent ? state.eventUiBases : { '': currentState.selectionConfig } // if not a real event, validate as a selection
        );
        if (filterConfig) {
    ...
    */
    ...
    function getAllowYScrolling(props, sectionConfig) {
        return (
            sectionConfig.maxHeight != null || getSectionHasLiquidHeight(props, sectionConfig) // if its possible for the height to max out, we might need scrollbars
            ...
            this.onDocumentPointerUp = function (pev) {
                ...
                if (!documentPointer.wasTouchScroll) {
                    if (
                        ...
                        if (
                            unselectAuto &&
                            (!unselectAuto || !elementClosest(documentPointer.downEl, unselectCancel))
                        ) {
    ...
    */
    ...
    function hasListItemDisplay(seg) {
        ...
        return (
            display === 'list-item' ||
            (display === 'auto' && !seg.eventRange.def.allDay && seg.firstCol === seg.lastCol) // can't be multi-day
        );
    }
    ...
    */
    ...
    var MorePopover = /** @class */ (function (_super) {
        ...
        MorePopover.prototype.render = function () {
            ...
            return createElement(
                DayCellRoot,
                { date: date, dateProfile: dateProfile, todayRange: todayRange, elRef: this.handlePopoverEl },
    ...
    */
    ...
    var TimeColsView = /** @class */ (function (_super) {
        ...
        TimeColsView.prototype.renderSimpleLayout = function (headerRowContent, allDayContent, timeContent) {
            ...
            return createElement(ViewRoot, { viewSpec: context.viewSpec, elRef: this.rootElRef }, function (
                rootElRef,
                classNames
            ) {
                return createElement(
                        ...
                        content: function (arg) {
                            ...
                            return createElement(
                                ...
                                createElement(
                                    ...
                                    null,
                                    arg.tableColGroupNode,
                                    createElement('tbody', null, createElement(TimeBodyAxis, { slatMetas: slatMetas }))
                                ),
                                createElement(
                                    'div',
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.renderNowIndicator = function (segs) {
            ...
            return segs.map(function (seg, i) {
                return createElement(
                    NowIndicatorRoot,
                    { isAxis: false, date: date, key: i /* key doesn't matter. will only ever be one */ },
                    function (rootElRef, classNames, innerElRef, innerContent) {
                        return createElement(
                            'div',
                            {
    ...
    */
    var ListView = /** @class */ (function (_super) {
        ...
        ListView.prototype.render = function () {
            ...
            return createElement(ViewRoot, { viewSpec: context.viewSpec, elRef: this.setRootEl }, function (
                rootElRef,
                classNames
            ) {
                return createElement(
