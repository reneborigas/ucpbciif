...
!(function (e, t) {
    if ('object' == typeof exports && 'object' == typeof module)
        module.exports = t(require('fullcalendar'), require('jquery'), require('moment'));
    else if ('function' == typeof define && define.amd) define(['fullcalendar', 'jquery', 'moment'], t);
    else {
        var r =
            'object' == typeof exports
                ? t(require('fullcalendar'), require('jquery'), require('moment'))
                : t(e.FullCalendar, e.jQuery, e.moment);
    ...
    return (function (e) {
                ...
                s = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.initResourceView = function () {
                            var e = this,
                                t = ['hasResources'];
                            this.canHandleSpecificResources || t.push('displayingDates'),
                                this.watch(
                                    'displayingResources',
                                    t,
                                    function () {
                                ...
                                this.watch(
                                    ...
                                    ['businessHourGenerator', 'displayingResources', 'displayingDates'],
                                    function (t) {
                        ...
                        (t.prototype.applyScroll = function (e) {
                            i.View.prototype.applyScroll.apply(this, arguments),
                                this.isResourcesRendered && this.applyResourceScroll(e);
                        }),
                        (t.prototype.queryResourceScroll = function () {
                            return {};
                        }),
                        (t.prototype.applyResourceScroll = function () {}),
                        (t.prototype.getResourceText = function (e) {
                        ...
                        (t.prototype.triggerDayClick = function (e, t, r) {
                            ...
                            this.publiclyTrigger('dayClick', {
                                ...
                                args: [
                                    ...
                                    r,
                                    this,
                                    e.resourceId ? this.calendar.resourceManager.getResourceById(e.resourceId) : null,
                                ],
                            });
                        }),
                ...
                l = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.renderResources = function (e) {
                            this.registerResources(e),
                                this.renderGrid(),
                                this.headContainerEl && this.processHeadResourceEls(this.headContainerEl);
                        }),
                        ...
                        (t.prototype.componentFootprintToSegs = function (e) {
                            for (
                                var t = this.resourceCnt,
                                    r = this.datesAboveResources
                                        ? this.sliceRangeByDay(e.unzonedRange)
                                        : this.sliceRangeByRow(e.unzonedRange),
                                    o = [],
                                    i = 0,
                                    s = r;
                                i < s.length;
                                ...
                                for (var l = s[i], c = 0; c < t; c++) {
                                    ...
                                    if (!(e instanceof a['default']) || e.resourceId === u.id) {
                                        ...
                                        (d.resource = u),
                                            this.isRTL
                                                ? ((d.leftCol = this.indicesToCol(c, l.lastRowDayIndex)),
                                                  (d.rightCol = this.indicesToCol(c, l.firstRowDayIndex)))
                                                : ((d.leftCol = this.indicesToCol(c, l.firstRowDayIndex)),
                                                  (d.rightCol = this.indicesToCol(c, l.lastRowDayIndex))),
                                            o.push(d);
                                    }
                                }
                            return o;
        ...
        function (e, t, r) {
            ...
            var o = r(1),
                ...
                y = (function (e) {
                    function t(t, r) {
                        ...
                        return (
                            (o.emphasizeWeeks = !1), (o.isTimeBodyScrolled = !1), (o.slotWidth = o.opt('slotWidth')), o
                        );
                    }
                    return (
                        o.__extends(t, e),
                        (t.prototype.normalizeComponentFootprint = function (e) {
                            var t,
                                r,
                                o = e.unzonedRange;
                            if (this.isTimeScale)
                                (r = this.normalizeGridDate(o.getStart())), (t = this.normalizeGridDate(o.getEnd()));
                            else {
                                var n = this.computeDayRange(o);
                                this.largeUnit
                                    ? ((r = n.start.clone().startOf(this.largeUnit)),
                                      (t = n.end.clone().startOf(this.largeUnit)),
                                      (t.isSame(n.end) && t.isAfter(r)) || t.add(this.slotDuration))
                                    : ((r = n.start), (t = n.end));
                            }
                        ...
                        (t.prototype.normalizeGridDate = function (e) {
                            var t = e.clone();
                            return (
                                this.calendar.localizeMoment(t),
                                this.isTimeScale
                                    ? t.hasTime() || t.time(0)
                                    : ((t = t.clone().stripTime()), this.largeUnit && t.startOf(this.largeUnit)),
                                t
                            );
                        }),
                        ...
                        (t.prototype.updateGridDates = function () {
                            for (
                                var e = -1, t = 0, r = [], o = [], n = this.normalizedUnzonedStart.clone();
                                n < this.normalizedUnzonedEnd;

                            )
                                this.isValidDate(n) ? (e++, r.push(e), o.push(t)) : r.push(e + 0.5),
                                    n.add(this.snapDuration),
                                    t++;
                            (this.snapDiffToIndex = r),
                                (this.snapIndexToDiff = o),
                                (this.snapCnt = e + 1),
                                (this.slotCnt = this.snapCnt / this.snapsPerSlot);
                        }),
                        (t.prototype.renderSkeleton = function () {
                            this.el.addClass('fc-timeline'),
                                this.opt('eventOverlap') === !1 && this.el.addClass('fc-no-overlap'),
                                ...
                                (this.timeHeadScroller = new a['default']({
                                    overflowX: 'clipped-scroll',
                                    overflowY: 'hidden',
                                })),
                                (this.timeHeadScroller.canvas = new l['default']()),
                                this.timeHeadScroller.render(),
                                this.timeHeadScroller.el.appendTo(this.timeHeadEl),
                                (this.timeBodyScroller = new a['default']()),
                                (this.timeBodyScroller.canvas = new l['default']()),
                                this.timeBodyScroller.render(),
                                this.timeBodyScroller.el.appendTo(this.timeBodyEl),
                                (this.isTimeBodyScrolled = !1),
                                this.timeBodyScroller.on('scroll', s.proxy(this, 'handleTimeBodyScrolled')),
                                (this.slatContainerEl = n('<div class="fc-slats"/>').appendTo(
                                    this.timeBodyScroller.canvas.bgEl
                                )),
                                (this.segContainerEl = n('<div class="fc-event-container"/>').appendTo(
                                    this.timeBodyScroller.canvas.contentEl
                                )),
                                (this.bgSegContainerEl = this.timeBodyScroller.canvas.bgEl),
                                (this.timeBodyBoundCache = new s.CoordCache({
                                    els: this.timeBodyScroller.canvas.el,
                                    isHorizontal: !0,
                                    isVertical: !0,
                                })),
                                (this.timeScrollJoiner = new c['default']('horizontal', [
                                    this.timeHeadScroller,
                                    this.timeBodyScroller,
                                ])),
                                (this.headDateFollower = new u['default'](this.timeHeadScroller, !0)),
                                (this.eventTitleFollower = new u['default'](this.timeBodyScroller)),
                                (this.eventTitleFollower.minTravel = 50),
                                this.isRTL
                                    ? (this.eventTitleFollower.containOnNaturalRight = !0)
                                    : (this.eventTitleFollower.containOnNaturalLeft = !0),
                        ...
                        (t.prototype.renderDates = function (e) {
                            g.initScaleProps(this),
                                (this.timeWindowMs = e.maxTime - e.minTime),
                                (this.normalizedUnzonedStart = this.normalizeGridDate(e.renderUnzonedRange.getStart())),
                                (this.normalizedUnzonedEnd = this.normalizeGridDate(e.renderUnzonedRange.getEnd())),
                                this.isTimeScale &&
                                    (this.normalizedUnzonedStart.add(e.minTime),
                                    this.normalizedUnzonedEnd.subtract(1, 'day').add(e.maxTime)),
                                (this.normalizedUnzonedRange = new s.UnzonedRange(
                                    this.normalizedUnzonedStart,
                                    this.normalizedUnzonedEnd
                                ));
                            var t = [],
                                r = this.normalizedUnzonedStart.clone();
                            for (this.calendar.localizeMoment(r); r < this.normalizedUnzonedEnd; )
                                this.isValidDate(r) && t.push(r.clone()), r.add(this.slotDuration);
                            (this.slotDates = t), this.updateGridDates();
                            var o = this.renderSlatHtml();
                            this.timeHeadScroller.canvas.contentEl.html(o.headHtml),
                                (this.timeHeadColEls = this.timeHeadScroller.canvas.contentEl.find('col')),
                                this.slatContainerEl.html(o.bodyHtml),
                                (this.slatColEls = this.slatContainerEl.find('col')),
                                (this.slatEls = this.slatContainerEl.find('td')),
                                (this.slatCoordCache = new s.CoordCache({ els: this.slatEls, isHorizontal: !0 })),
                                (this.slatInnerCoordCache = new s.CoordCache({
                                    els: this.slatEls.find('> div'),
                                    isHorizontal: !0,
                                    offsetParent: this.timeBodyScroller.canvas.el,
                                }));
                            for (var n = 0; n < this.slotDates.length; n++)
                                (r = this.slotDates[n]),
                                    this.publiclyTrigger('dayRender', {
                                        context: this,
                                        args: [r, this.slatEls.eq(n), this],
                                    });
                            this.headDateFollower &&
                                this.headDateFollower.setSpriteEls(
                                    this.timeHeadEl.find('tr:not(:last-child) .fc-cell-text')
                                );
                        }),
                        (t.prototype.unrenderDates = function () {
                            this.headDateFollower && this.headDateFollower.clearSprites(),
                        ...
                        (t.prototype.renderSlatHtml = function () {
                            for (
                                var e,
                                    ...
                                    r,
                                    o,
                                    n = this.calendar.theme,
                                    i = this.labelInterval,
                                    a = this.headerFormats,
                                    l = a.map(function (e) {
                                        return [];
                                    }),
                                    c = null,
                                ...
                                t = v[f];
                                for (
                                    var g = t.week(), y = this.emphasizeWeeks && null !== u && u !== g, m = 0;
                                    m < a.length;
                                    m++
                                ) {
                                    ...
                                    if (R) {
                                        ...
                                        !c ||
                                        s.isInt(s.divideRangeByDuration(this.normalizedUnzonedStart, t, i))
                                    ) {
                                        var b = t.format(o);
                            ...
                            for (var T = 0; T < l.length; T++) {
                                ...
                                for (var x = 0, M = r; x < M.length; x++) {
                                    ...
                                    e.weekStart && z.push('fc-em-cell'),
                                        E && (z = z.concat(this.getDayClasses(e.date, !0))),
                                        (C +=
                                            '<th class="' +
                                            z.join(' ') +
                                            '" data-date="' +
                            ...
                            for (var T = 0; T < h.length; T++)
                                (e = h[T]), (t = d[T]), (F += this.slatCellHtml(t, e.weekStart));
                            return (F += '</tr></tbody></table>'), { headHtml: C, bodyHtml: F };
                        }),
                        (t.prototype.buildCellObject = function (e, t, r) {
                            e = e.clone();
                            var o = this.buildGotoAnchorHtml(
                                { date: e, type: r, forceOff: !r },
                                { class: 'fc-cell-text' },
                                s.htmlEscape(t)
                            );
                            return { text: t, spanHtml: o, date: e, colspan: 1 };
                        }),
                        (t.prototype.slatCellHtml = function (e, t) {
                            var r,
                                o = this.calendar.theme;
                            return (
                                this.isTimeScale
                                    ? ((r = []),
                                      r.push(
                                          s.isInt(
                                              s.divideRangeByDuration(
                                                  this.normalizedUnzonedStart,
                                                  e,
                                                  this.labelInterval
                                              )
                                    ...
                                    : ((r = this.getDayClasses(e)), r.push('fc-day')),
                                r.unshift(o.getClass('widgetContent')),
                                t && r.push('fc-em-cell'),
                                '<td class="' + r.join(' ') + '" data-date="' + e.format() + '"><div /></td>'
                            );
                        }),
                        ...
                        (t.prototype.renderNowIndicator = function (e) {
                            ...
                            if (((e = this.normalizeGridDate(e)), this.normalizedUnzonedRange.containsDate(e))) {
                                var r = this.dateToCoord(e),
                                    o = this.isRTL ? { right: -r } : { left: r };
                                t.push(
                                    n("<div class='fc-now-indicator fc-now-indicator-arrow'></div>")
                                        .css(o)
                                        .appendTo(this.timeHeadScroller.canvas.el)[0]
                                ),
                                    t.push(
                                        n("<div class='fc-now-indicator fc-now-indicator-line'></div>")
                                            .css(o)
                        ...
                        (t.prototype.updateSize = function (e, t, r) {
                            var o, n, i, s;
                            (o = t ? 'auto' : e - this.headHeight() - this.queryMiscHeight()),
                                this.timeBodyScroller.setHeight(o);
                            ...
                            this.timeHeadScroller.canvas.setWidth(i),
                                this.timeHeadScroller.canvas.setMinWidth(n),
                                this.timeBodyScroller.canvas.setWidth(i),
                                this.timeBodyScroller.canvas.setMinWidth(n),
                                a && this.timeHeadColEls.slice(0, -1).add(this.slatColEls.slice(0, -1)).css('width', s),
                                this.timeHeadScroller.updateSize(),
                                this.timeBodyScroller.updateSize(),
                                this.timeScrollJoiner.update(),
                                a && (this.buildCoords(), this.updateSegPositions(), this.updateNowIndicator()),
                                this.headDateFollower && this.headDateFollower.update(),
                                this.eventTitleFollower && this.eventTitleFollower.update();
                        }),
                        ...
                        (t.prototype.dateToCoord = function (e) {
                            ...
                            return this.isRTL
                                ? i.getRightPosition(o) - i.getWidth(o) * n - this.timeBodyBoundCache.getWidth(0)
                                : i.getLeftPosition(o) + i.getWidth(o) * n;
                        }),
                        (t.prototype.rangeToCoords = function (e) {
                            return this.isRTL
                                ? { right: this.dateToCoord(e.start), left: this.dateToCoord(e.end) }
                        ...
                        (t.prototype.updateSegPositions = function () {
                            for (
                                var e = [].concat(this.getEventSegs(), this.getBusinessHourSegs()), t = 0, r = e;
                                t < r.length;
                                t++
                            ) {
                                var o = r[t],
                                    n = this.rangeToCoords(o);
                                o.el.css({ left: (o.left = n.left), right: -(o.right = n.right) });
                            }
                        }),
                        (t.prototype.handleTimeBodyScrolled = function (e) {
                            e
                                ? this.isTimeBodyScrolled ||
                                  ((this.isTimeBodyScrolled = !0), this.el.addClass('fc-scrolled'))
                                : this.isTimeBodyScrolled &&
                                  ((this.isTimeBodyScrolled = !1), this.el.removeClass('fc-scrolled'));
                        }),
                        ...
                        (t.prototype.applyDateScroll = function (e) {
                            null != e.left &&
                                (this.timeHeadScroller.setScrollLeft(e.left),
                                this.timeBodyScroller.setScrollLeft(e.left));
                        }),
            ...
            (t['default'] = y),
                (y.prototype.usesMinMaxTime = !0),
                (y.prototype.eventRendererClass = d['default']),
                (y.prototype.fillRendererClass = h['default']),
                (y.prototype.businessHourRendererClass = s.BusinessHourRenderer),
                (y.prototype.helperRendererClass = p['default']),
                (y.prototype.eventDraggingClass = f['default']),
                (y.prototype.eventResizingClass = v['default']),
                s.StandardInteractionsMixin.mixInto(y);
        },
        function (e, t) {
            e.exports = r;
        },
                    ...
                    (e.prototype.update = function () {
                        for (
                            var e,
                                t,
                                r,
                                o = this.scrollers.map(function (e) {
                        ...
                        for (r = 0; r < this.scrollers.length; r++)
                            (e = this.scrollers[r]),
                                (t = o[r]),
                                e.canvas.setGutters(
                                    'horizontal' === this.axis
                                        ? { left: n - t.left, right: i - t.right }
                                        : { top: s - t.top, bottom: a - t.bottom }
                                );
                    }),
                    e
                );
                    ...
                    return (
                        ...
                        (t.prototype.renderFgSegs = function (e) {
                            for (var t = this.view.eventTitleFollower, r = 0, n = e; r < n.length; r++) {
                                ...
                                i.el.css({ left: (i.left = s.left), right: -(i.right = s.right) });
                            }
                            ...
                            for (var f = 0, v = e; f < v.length; f++) {
                                ...
                                g.length &&
                                    ((i.scrollFollowerSprite = new l['default'](g)),
                                    t.addSprite(i.scrollFollowerSprite));
                            }
                        }),
                        ...
                        (t.prototype.fgSegHtml = function (e, t) {
                            ...
                            return (
                                ...
                                s.join(' ') +
                                '" style="' +
                                a.cssToStr(this.getSkinCss(e.footprint.eventDef)) +
                                '"' +
                                (r.url ? ' href="' + a.htmlEscape(r.url) + '"' : '') +
                                '><div class="fc-content">' +
                                (l ? '<span class="fc-time">' + a.htmlEscape(l) + '</span>' : '') +
                                '<span class="fc-title">' +
                                (r.title ? a.htmlEscape(r.title) : '&nbsp;') +
                                '</span></div><div class="fc-bg" />' +
                                (n ? '<div class="fc-resizer fc-start-resizer"></div>' : '') +
                                (i ? '<div class="fc-resizer fc-end-resizer"></div>' : '') +
                                '</a>'
                            );
                        }),
                        t
                ...
                a = (function (e) {
                    function t(t) {
                        ...
                        return (
                            ...
                            (r.trHash = {}),
                            (r.trs = n()),
                            (r.isExpanded = r.view.opt('resourcesInitiallyExpanded')),
                            r
                        );
                    }
                    return (
                        o.__extends(t, e),
                        (t.prototype.addChildRowNode = function (e, t) {
                            e.removeFromParentAndDom();
                            var r = this.children;
                            null != t ? r.splice(t, 0, e) : ((t = r.length), r.push(e)),
                                (e.prevSibling = t > 0 ? r[t - 1] : null),
                                t < r.length - 1 && (r[t + 1].prevSibling = e),
                                (e.parent = this),
                                (e.depth = this.depth + (this.hasOwnRow ? 1 : 0)),
                                this.descendantAdded(e);
                        }),
                        (t.prototype.removeChild = function (e) {
                            ...
                            return (
                                !!o &&
                                (t < r.length - 1 && (r[t + 1].prevSibling = e.prevSibling),
                                r.splice(t, 1),
                                (e.parent = null),
                                (e.prevSibling = null),
                                this.descendantRemoved(e),
                                e)
                            );
                        }),
                        ...
                        (t.prototype.getLeadingRow = function () {
                            return this.hasOwnRow
                                ? this
                                : this.isExpanded && this.children.length
                                ? this.children[0].getLeadingRow()
                                : void 0;
                        }),
                        ...
                        (t.prototype.renderSkeleton = function () {
                            ...
                            if (this.hasOwnRow) {
                                ...
                                (this.trs = n(e).on('click', '.fc-expander', i.proxy(this, 'toggleExpanded'))),
                                    this.thisRowShown();
                            }
                        ...
                        (t.prototype.indicateExpandingEnabled = function () {
                            this.trs.find('.fc-expander-space').addClass('fc-expander'),
                                this.isExpanded ? this.indicateExpanded() : this.indicateCollapsed();
                        }),
                        (t.prototype.indicateExpandingDisabled = function () {
                            this.trs
                                .find('.fc-expander-space')
                        ...
                        (t.prototype.updateExpandingEnabled = function () {
                            this.hasOwnRow && this.children.length
                        ...
                        (t.prototype.descendantAdded = function (e) {
                            this.get('isInDom') &&
                                ...
                                this.indicateExpandingEnabled(),
                                (this.parent || this.view).descendantAdded(e);
                        }),
                        (t.prototype.descendantRemoved = function (e) {
                            this.get('isInDom') &&
                                ...
                                this.indicateExpandingDisabled(),
                                (this.parent || this.view).descendantRemoved(e);
                        }),
        ...
        function (e, t, r) {
            ...
            (t['default'] = l),
                (l.prototype.timeGridClass = a['default']),
                (l.prototype.dayGridClass = s['default']),
                i['default'].mixInto(l);
        },
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
                    ...
                    return (
                        ...
                        (t.prototype.updateDayTableCols = function () {
                            (this.datesAboveResources = this.opt('groupByDateAndResource')),
                                i.DayTableMixin.prototype.updateDayTableCols.call(this);
                        }),
                        ...
                        (t.prototype.getColDayIndex = function (e) {
                            return (
                                this.isRTL && (e = this.colCnt - 1 - e),
                                this.datesAboveResources ? Math.floor(e / (this.resourceCnt || 1)) : e % this.daysPerRow
                            );
                        }),
                        ...
                        (t.prototype.getColResourceIndex = function (e) {
                            return (
                                this.isRTL && (e = this.colCnt - 1 - e),
                                this.datesAboveResources ? e % (this.resourceCnt || 1) : Math.floor(e / this.daysPerRow)
                            );
                        }),
                        (t.prototype.indicesToCol = function (e, t) {
                            var r = this.datesAboveResources
                                ? t * (this.resourceCnt || 1) + e
                                : e * this.daysPerRow + t;
                        ...
                        (t.prototype.renderHeadTrHtml = function () {
                            return this.daysPerRow > 1
                                ? this.datesAboveResources
                                    ? this.renderHeadDateAndResourceHtml()
                                    : this.renderHeadResourceAndDateHtml()
                                : this.renderHeadResourceHtml();
                        }),
                        ...
                        (t.prototype.renderHeadResourceAndDateHtml = function () {
                            for (
                                var e = [], t = [], r = this.daysPerRow, o = 0, n = this.flattenedResources;
                                o < n.length;
                                o++
                            ) {
                                var i = n[o];
                            ...
                            return (
                                e.length || e.push('<td>&nbsp;</td>'),
                                t.length || t.push('<td>&nbsp;</td>'),
                                this.wrapTr(e, 'renderHeadIntroHtml') + this.wrapTr(t, 'renderHeadIntroHtml')
                            );
                        }),
                        ...
                        (t.prototype.renderHeadResourceCellHtml = function (e, t, r) {
                            return (
                                ...
                                '<th class="fc-resource-cell" data-resource-id="' +
                                    e.id +
                                    '"' +
                                    (t ? ' data-date="' + t.format('YYYY-MM-DD') + '"' : '') +
                                    (r > 1 ? ' colspan="' + r + '"' : '') +
                                    '>' +
                                    i.htmlEscape(this.view.getResourceText(e)) +
                                    '</th>'
                            );
                        }),
                        (t.prototype.renderHeadResourceDateCellHtml = function (e, t, r) {
                            return (
                                void 0 === r && (r = 1),
                                this.renderHeadDateCellHtml(e, r, 'data-resource-id="' + t.id + '"')
                            );
                        }),
                        (t.prototype.processHeadResourceEls = function (e) {
                            ...
                            e.find('.fc-resource-cell').each(function (e, r) {
                                var o;
                                (o = t.datesAboveResources
                                    ? t.getColResource(e)
                                    : t.flattenedResources[t.isRTL ? t.flattenedResources.length - 1 - e : e]),
                                    t.publiclyTrigger('resourceRender', { context: o, args: [o, n(r), n(), t.view] });
                            });
                        }),
                        ...
                        (t.prototype.wrapTr = function (e, t) {
                            return this.isRTL
                                ? (e.reverse(), '<tr>' + e.join('') + this[t]() + '</tr>')
                                : '<tr>' + this[t]() + e.join('') + '</tr>';
                        }),
                        (t.prototype.renderBusinessHours = function (e) {
                            for (
                                var t = this.hasAllDayBusinessHours,
                                    r = this.dateProfile.activeUnzonedRange,
                                    o = [],
                                    n = 0,
                                    a = this.flattenedResources;
                                n < a.length;
                                n++
                            ) {
                                var l = a[n],
                                ...
                                if (c)
                                    for (var u = 0, d = c.sliceRenderRanges(r); u < d.length; u++) {
                                        var h = d[u];
                                        o.push(
                                            new i.EventFootprint(
                                                new s['default'](h.unzonedRange, t, l.id),
                                                h.eventDef,
                                                h.eventInstance
                                            )
                                        );
            ...
            (t['default'] = a),
                (a.prototype.resourceCnt = 0),
                (a.prototype.datesAboveResources = !1),
                (a.prototype.allowCrossResource = !1);
        },
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
            var o = r(1),
            ...
            var o = r(1),
                ...
                a = (function (e) {
                    function t(t) {
                        var r = e.call(this, t) || this;
                        return (
                            (r.isHScrollbarsClipped = !1),
                            (r.isVScrollbarsClipped = !1),
                            'clipped-scroll' === r.overflowX &&
                                ((r.overflowX = 'scroll'), (r.isHScrollbarsClipped = !0)),
                            'clipped-scroll' === r.overflowY &&
                                ((r.overflowY = 'scroll'), (r.isVScrollbarsClipped = !0)),
                            r
                        );
                    }
                    return (
                        ...
                        (t.prototype.updateSize = function () {
                            var e = this.scrollEl,
                                ...
                                r = { marginLeft: 0, marginRight: 0, marginTop: 0, marginBottom: 0 };
                            return (
                                this.isHScrollbarsClipped && ((r.marginTop = -t.top), (r.marginBottom = -t.bottom)),
                                this.isVScrollbarsClipped && ((r.marginLeft = -t.left), (r.marginRight = -t.right)),
                                e.css(r),
                                e.toggleClass(
                                    'fc-no-scrollbars',
                                    (this.isHScrollbarsClipped || 'hidden' === this.overflowX) &&
                                        (this.isVScrollbarsClipped || 'hidden' === this.overflowY) &&
                        ...
                        (t.prototype.getScrollbarWidths = function () {
                            ...
                            return (
                                this.isHScrollbarsClipped && ((e.top = 0), (e.bottom = 0)),
                ...
                n = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.updateSize = function () {
                            var e = this.gutters;
                            this.el
                                .toggleClass('fc-gutter-left', Boolean(e.left))
                                .toggleClass('fc-gutter-right', Boolean(e.right))
                                .toggleClass('fc-gutter-top', Boolean(e.top))
                                .toggleClass('fc-gutter-bottom', Boolean(e.bottom))
                                .css({
                                    paddingLeft: e.left || '',
                                    ...
                                    minWidth:
                                        null != this.minWidth ? this.minWidth + (e.left || 0) + (e.right || 0) : '',
                                }),
                                this.bgEl.css({
                                    left: e.left || '',
                                    right: e.right || '',
            ...
            var o = r(2),
                ...
                s = (function () {
                    function e(e, t) {
                        ...
                        (this.isHFollowing = !0),
                            (this.isVFollowing = !1),
                            (this.allowPointerEvents = !1),
                            (this.containOnNaturalLeft = !1),
                            (this.containOnNaturalRight = !1),
                            (this.minTravel = 0),
                            (this.allowPointerEvents = t),
                            (this.scroller = e),
                            (this.spritesById = {}),
                            e.on('scroll', function () {
                                e.isTouchedEver
                                    ? ((r.isTouch = !0), (r.isForcedRelative = !0))
                                    : ((r.isTouch = !1), r.handleScroll());
                            }),
                    ...
                    return (
                        (e.prototype.setSpriteEls = function (e) {
                            var t = this;
                            this.clearSprites(),
                                e.each(function (e, r) {
                        ...
                        (e.prototype.forceRelative = function () {
                            this.isForcedRelative ||
                                ((this.isForcedRelative = !0),
                                this.iterSprites(function (e) {
        ...
        function (e, t, r) {
            ...
            function c(e, t) {
                return e.left < t.left
                    ? ((e.right = t.left + n(e)), (e.left = t.left), !0)
                    : e.right > t.right && ((e.left = t.right - n(e)), (e.right = t.right), !0);
            }
            function u(e, t) {
                return e.top < t.top
                    ? ((e.bottom = t.top + i(e)), (e.top = t.top), !0)
                    : e.bottom > t.bottom && ((e.top = t.bottom - i(e)), (e.bottom = t.bottom), !0);
            }
            function d(e, t) {
                return {
                ...
                p = (function () {
                    function e(t) {
                        (this.isEnabled = !0),
                            ...
                            (this.isBlock = !1),
                            (this.el = t),
                            (this.id = String(e.uid++)),
                            (this.isBlock = 'block' === this.el.css('display')),
                            'relative' !== this.el.css('position') && this.el.css('position', 'relative');
                    }
                    return (
                        ...
                        (e.prototype.cacheDimensions = function () {
                            ...
                            var l = (this.containerRect = d(o.getContentRect(a), s)),
                                c = o.minTravel;
                            o.containOnNaturalLeft && (l.left = s.left),
                                o.containOnNaturalRight && (l.right = s.right),
                                o.isHFollowing &&
                                    n(l) - n(s) >= c &&
                                    ((r = 'center' === this.el.css('text-align')), (e = !0)),
                                o.isVFollowing && i(l) - i(s) >= c && (t = !0),
                                (this.isHFollowing = e),
                                (this.isVFollowing = t),
                                (this.isCentered = r);
                        }),
                        ...
                        (e.prototype.computePosition = function () {
                            ...
                            if (i) {
                                ...
                                if ((this.isCentered && !s(e, t)) || (d && !s(e, d))) {
                                    ...
                                    this.isVFollowing && (u(a, e) || (l = !1), u(a, r) && (l = !1)),
                                        s(e, a) || (l = !1);
                                }
                            }
                        ...
                        (e.prototype.assignPosition = function () {
                            if (this.isEnabled)
                                if (this.rect)
                                    if (this.doAbsolute && !this.follower.isForcedRelative)
                                        this.absolutize(),
                                            this.absoluteEl.css({
                                                top:
                                                    this.rect.top -
                                                    this.follower.viewportRect.top +
                                                    this.follower.scrollbarWidths.top,
                                                left:
                                                    this.rect.left -
                                                    this.follower.viewportRect.left +
                                                    this.follower.scrollbarWidths.left,
                                        ...
                                        this.unabsolutize(),
                                            this.el
                                                .toggleClass('fc-following', Boolean(e || t))
                                                .css({ top: e, left: t });
                                    }
                        ...
                        (e.prototype.absolutize = function () {
                            this.isAbsolute ||
                                (this.absoluteEl || (this.absoluteEl = this.buildAbsoluteEl()),
                        ...
                        (e.prototype.unabsolutize = function () {
                            this.isAbsolute &&
                                (this.absoluteEl.detach(), this.el.css('visibility', ''), (this.isAbsolute = !1));
                        }),
                        (e.prototype.buildAbsoluteEl = function () {
                            ...
                            return (
                                ...
                                this.follower.allowPointerEvents || e.css('pointer-events', 'none'),
                                e
                            );
                        }),
                        (e.uid = 0),
        ...
        function (e, t, r) {
            ...
            var o = r(1),
                ...
                s = (function (e) {
                    ...
                    return (
                        o.__extends(t, e),
                        (t.prototype.attachSegEls = function (e, t) {
                            if (t.length) {
                                var r = void 0;
                                r = 'businessHours' === e ? 'bgevent' : e.toLowerCase();
                                for (
                                    var o = n('<div class="fc-' + r + '-container" />').appendTo(
                                            this.component.bgSegContainerEl
                                        ),
                                        i = 0,
                                        s = t;
                                    i < s.length;
                                    ...
                                    a.el.css({ left: (a.left = l.left), right: -(a.right = l.right) }),
                                        a.el.appendTo(o);
                                }
                                return o;
                            }
                    ...
                    return (
                        ...
                        (t.prototype.renderSegs = function (e, t) {
                            for (var r = [], o = 0, i = e; o < i.length; o++) {
                                ...
                                s.el.css({ left: (s.left = a.left), right: -(s.right = a.right) }),
                                    t &&
                                    t.resourceId ===
                                        (null != this.component.resource ? this.component.resource.id : void 0)
                                        ? s.el.css('top', t.el.css('top'))
                                        : s.el.css('top', 0);
                            }
                            var l = n('<div class="fc-event-container fc-helper-container"/>').appendTo(
                                this.component.innerEl
                            );
                            r.push(l[0]);
            ...
            var i = r(1),
                ...
                R = (function (e) {
                    function t(t, r) {
                        var o = e.call(this, t, r) || this;
                        return (
                            (o.canHandleSpecificResources = !0),
                            (o.isResourceFootprintsEnabled = !0),
                            (o.nestingCnt = 0),
                            (o.indiBizCnt = 0),
                            (o.isIndiBizRendered = !1),
                            (o.isGenericBizRendered = !1),
                            o.initResourceView(),
                            o.processResourceOptions(),
                            (o.spreadsheet = new h['default'](o)),
                            (o.rowHierarchy = new f['default'](o)),
                            (o.rowHierarchy.isExpanded = !0),
                            (o.resourceRowHash = {}),
                            o
                        );
                    }
                    return (
                        i.__extends(t, e),
                        (t.prototype.processResourceOptions = function () {
                            var e = this.opt('resourceColumns') || [],
                                t = this.opt('resourceLabelText'),
                                r = 'Resources',
                                o = null;
                            e.length ? (o = t) : e.push({ labelText: t || r, text: this.getResourceTextFunc() });
                            ...
                            for (
                                var f = a.parseFieldSpecs(this.opt('resourceOrder')), v = [], g = 0, y = f;
                                g < y.length;
                                g++
                            ) {
                            ...
                            (this.superHeaderText = o),
                                (this.isVGrouping = l),
                                (this.isHGrouping = c),
                                (this.groupSpecs = s),
                                (this.colSpecs = i.concat(n)),
                                (this.orderSpecs = v);
                        }),
                        (t.prototype.renderSkeleton = function () {
                            e.prototype.renderSkeleton.call(this);
                        ...
                        (t.prototype.initDividerMoving = function () {
                            ...
                            (this.dividerEls = this.el.find('.fc-divider')),
                                (this.dividerWidth = null != t ? t : this.spreadsheet.tableWidth),
                                null != this.dividerWidth && this.positionDivider(this.dividerWidth),
                                this.dividerEls.on('mousedown', function (t) {
                        ...
                        (t.prototype.updateSize = function (t, r, o) {
                            ...
                            this.rowsNeedingHeightSync
                                ? (this.syncRowHeights(this.rowsNeedingHeightSync), (this.rowsNeedingHeightSync = null))
                                : this.syncRowHeights();
                            var i = this.syncHeadHeights();
                            (n = r ? 'auto' : t - i - this.queryMiscHeight()),
                                this.timeBodyScroller.setHeight(n),
                                this.spreadsheet.bodyScroller.setHeight(n),
                                this.spreadsheet.updateSize(),
                                e.prototype.updateSize.call(this, t, r, o),
                        ...
                        (t.prototype.queryMiscHeight = function () {
                            return (
                                this.el.outerHeight() -
                                Math.max(
                                    this.spreadsheet.headScroller.el.outerHeight(),
                                    this.timeHeadScroller.el.outerHeight()
                                ) -
                                Math.max(
                                    this.spreadsheet.bodyScroller.el.outerHeight(),
                                    this.timeBodyScroller.el.outerHeight()
                                )
                            );
                        }),
                        ...
                        (t.prototype.queryResourceScroll = function () {
                            for (
                                var e = {},
                                    t = this.timeBodyScroller.scrollEl.offset().top,
                                    r = 0,
                                    o = this.getVisibleRows();
                                r < o.length;
                                r++
                            ) {
                                var n = o[r];
                                ...
                                if (t) {
                                    ...
                                    if (r) {
                                        var o = this.timeBodyScroller.canvas.el.offset().top,
                                            ...
                                            i = n - e.bottom - o;
                                        this.timeBodyScroller.setScrollTop(i),
                                            this.spreadsheet.bodyScroller.setScrollTop(i);
                                    }
                                }
                            }
                        }),
                        (t.prototype.scrollToResource = function (e) {
                            ...
                            if (t) {
                                ...
                                if (r) {
                                    var o = this.timeBodyScroller.canvas.el.offset().top,
                                        n = r.offset().top - o;
                                    this.timeBodyScroller.setScrollTop(n),
                                        this.spreadsheet.bodyScroller.setScrollTop(n);
                                }
                            }
                        }),
                        (t.prototype.prepareHits = function () {
                            var t = [];
                            e.prototype.prepareHits.call(this),
                                (this.eventRows = this.getEventRows()),
                                this.eventRows.forEach(function (e) {
                                    e.get('isInDom') && t.push(e);
                                });
                            var r = t.map(function (e) {
                                return e.getTr('event')[0];
                            });
                            (this.shownEventRows = t),
                                (this.rowCoordCache = new a.CoordCache({ els: r, isVertical: !0 })),
                                this.rowCoordCache.build();
                        }),
                        (t.prototype.releaseHits = function () {
                            e.prototype.releaseHits.call(this),
                                (this.eventRows = null),
                        ...
                        (t.prototype.renderBusinessHours = function (e) {
                            if (
                                ((this.genericBiz = e),
                                (this.isIndiBizRendered = !1),
                                (this.isGenericBizRendered = !1),
                                this.indiBizCnt)
                            ) {
                        ...
                        (t.prototype.updateIndiBiz = function () {
                            ((this.indiBizCnt && this.isGenericBizRendered) ||
                                ...
                                (this.unrenderBusinessHours(), this.renderBusinessHours(this.genericBiz));
                        }),
                        (t.prototype.insertResource = function (e, t) {
                            ...
                            t ||
                                (e.parent
                                    ? (t = this.getResourceRow(e.parent.id))
                                    : e.parentId && (t = this.getResourceRow(e.parentId))),
                                t ? this.insertRowAsChild(o, t) : this.insertRow(o),
                                this.addChild(o),
                                (this.resourceRowHash[e.id] = o),
                                e.businessHourGenerator &&
                                    (this.indiBizCnt++,
                                    this.isIndiBizRendered && (o.businessHourGenerator = e.businessHourGenerator),
                                    this.updateIndiBiz());
                        ...
                        (t.prototype.removeResource = function (e) {
                            ...
                            return (
                                t &&
                                    (delete this.resourceRowHash[e.id],
                                    this.removeChild(t),
                                    t.removeFromParentAndDom(),
                                    e.businessHourGenerator && (this.indiBizCnt--, this.updateIndiBiz())),
                                t
                            );
                        }),
                        (t.prototype.insertRow = function (e, t, r) {
                            if (
                                (void 0 === t && (t = this.rowHierarchy),
                                void 0 === r && (r = this.groupSpecs),
                                r.length)
                            ) {
                                var o = this.ensureResourceGroup(e, t, r[0]);
                                o instanceof g['default']
                                    ? this.insertRowAsChild(e, o)
                                    : this.insertRow(e, o, r.slice(1));
                        ...
                        (t.prototype.ensureResourceGroup = function (e, t, r) {
                            ...
                            return (
                                s ||
                                    ((s = this.isVGrouping
                                        ? new y['default'](this, r, i)
                                        : new g['default'](this, r, i)),
                                    t.addChildRowNode(s, o),
                                    s.renderSkeleton()),
                                s
                            );
                        }),
                        (t.prototype.descendantAdded = function (e) {
                            ...
                            t !== r &&
                                (this.el.toggleClass('fc-nested', r).toggleClass('fc-flat', !r), (this.isNesting = r));
                        }),
                        (t.prototype.descendantRemoved = function (e) {
                            var t = this.isNesting,
                                r = Boolean((this.nestingCnt -= e.depth ? 1 : 0));
                        ...
                        (t.prototype.renderDrag = function (e, t, r) {
                            ...
                            if (t) {
                                for (i in a)
                                    (n = a[i]),
                                        (s = this.getResourceRow(i)),
                                        s.helperRenderer.renderEventDraggingFootprints(n, t, r);
                                return !0;
                            }
                            for (i in a) {
                                n = a[i];
        ...
        function (e, t, r) {
            ...
            var o = r(1),
                ...
                s = (function (e) {
                    ...
                    return (
                        o.__extends(t, e),
                        (t.prototype.renderRowspan = function () {
                            var e,
                                t = this.view.calendar.theme;
                            this.rowspan
                                ? (this.groupTd ||
                                      (this.groupTd = n('<td class="' + t.getClass('widgetContent') + '"/>').append(
                                          this.renderGroupContentEl()
                                      )),
                                  this.groupTd.attr('rowspan', this.rowspan),
                                  (e = this.getLeadingRow().getTr('spreadsheet')),
                                  e !== this.leadingTr && (e && e.prepend(this.groupTd), (this.leadingTr = e)))
                                : (this.groupTd && (this.groupTd.remove(), (this.groupTd = null)),
                                  (this.leadingTr = null));
                        }),
        ...
        function (e, t, r) {
            ...
            var o = r(1),
                ...
                s = (function (e) {
                    ...
                    return (
                        o.__extends(t, e),
                        (t.prototype.descendantRemoved = function (t) {
                            e.prototype.descendantRemoved.call(this, t),
                                this.children.length || this.removeFromParentAndDom();
                        }),
                        ...
                        (t.prototype.renderGroupTextEl = function () {
                            ...
                            return (
                                'function' == typeof t && (e = t(e) || e), n('<span class="fc-cell-text" />').text(e)
                            );
                        }),
                        t
                    );
        ...
        function (e, t, r) {
                        ...
                        (t.prototype.renderEventSkeleton = function (e) {
                            ...
                            e.html(
                                '<td class="' +
                                    ...
                                    '"> <div> <div class="fc-event-container" /> </div> </td>'
                            ),
                                (this.segContainerEl = e.find('.fc-event-container')),
                                (this.innerEl = this.bgSegContainerEl = e.find('td > div'));
                        }),
                        (t.prototype.rangeToCoords = function (e) {
            ...
            (t['default'] = c),
                (c.prototype.fillRendererClass = s['default']),
                (c.prototype.eventRendererClass = a['default']),
                (c.prototype.helperRendererClass = l['default']),
                (c.prototype.businessHourRendererClass = n.BusinessHourRenderer),
                (c.prototype.hasOwnRow = !0);
        },
        ,
        ,
        function (e, t, r) {
            ...
            r(37),
                ...
                r(68);
            var n = '1.9.4';
            if (((o.schedulerVersion = n), 12 !== o.internalApiVersion))
                throw new Error(
                    'v' +
                        n +
                        ' of FullCalendar Scheduler is incompatible with v' +
                        o.version +
        ...
        function (e, t, r) {
            ...
            var o = r(0),
                ...
                a = r(14),
                l = r(30);
            (o.ResourceAgendaView = n['default']),
                (o.ResourceBasicView = i['default']),
                (o.ResourceMonthView = s['default']),
                (o.TimelineView = a['default']),
                (o.ResourceTimelineView = l['default']);
        },
        function (e, t, r) {
                ...
                l = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.componentFootprintToSegs = function (e) {
                            for (
                                var t = this.resourceCnt,
                                    r = this.sliceRangeByTimes(e.unzonedRange),
                                    o = [],
                                    i = 0,
                                    s = r;
                                i < s.length;
        ...
        function (e, t, r) {
                ...
                var e = i(
                    ...
                    r = (function () {
                        return t.scrollLeft > 0
                            ? 'positive'
                            : ((t.scrollLeft = 1), t.scrollLeft > 0 ? 'reverse' : 'negative');
                    })();
                return e.remove(), r;
            }
            Object.defineProperty(t, '__esModule', { value: !0 });
                ...
                l = (function (e) {
                    function t(t) {
                        ...
                        return (
                            ...
                            (r.requestMovingEnd = s.debounce(r.reportMovingEnd, 500)),
                            r
                        );
                    }
                    return (
                        ...
                        (t.prototype.render = function () {
                            e.prototype.render.call(this),
                                this.canvas && (this.canvas.render(), this.canvas.el.appendTo(this.scrollEl)),
                                this.bindHandlers();
                        }),
                        ...
                        (t.prototype.bindPreventTouchScroll = function () {
                            this.preventTouchScrollHandler ||
                                this.scrollEl.on('touchmove', (this.preventTouchScrollHandler = s.preventDefault));
                        }),
                        ...
                        (t.prototype.reportScroll = function () {
                            this.isScrolling || this.reportScrollStart(),
                                this.trigger('scroll'),
                                (this.isMoving = !0),
                        ...
                        (t.prototype.reportTouchEnd = function () {
                            this.isTouching &&
                                ((this.isTouching = !1),
                                this.isTouchScrollEnabled && this.unbindPreventTouchScroll(),
                                this.isMoving || this.reportScrollEnd());
                        }),
            ...
            (t['default'] = l),
                s.EmitterMixin.mixInto(l),
                s.ListenerMixin.mixInto(l),
                i(function () {
                    a = o();
                });
        },
        function (e, t, r) {
            ...
            var o = r(1),
                ...
                i = (function (e) {
                    ...
                    return (
                        o.__extends(t, e),
                        (t.prototype.segDragStart = function (t, r) {
                            e.prototype.segDragStart.call(this, t, r),
                                this.component.eventTitleFollower && this.component.eventTitleFollower.forceRelative();
                        }),
                        (t.prototype.segDragStop = function (t, r) {
                            e.prototype.segDragStop.call(this, t, r),
                                this.component.eventTitleFollower && this.component.eventTitleFollower.clearForce();
                        }),
                        t
                    );
                })(n.EventDragging);
        ...
        function (e, t, r) {
            ...
            var o = r(1),
                ...
                i = (function (e) {
                    ...
                    return (
                        o.__extends(t, e),
                        (t.prototype.segResizeStart = function (t, r) {
                            if ((e.prototype.segResizeStart.call(this, t, r), this.component.eventTitleFollower))
                                return this.component.eventTitleFollower.forceRelative();
                        }),
                        (t.prototype.segResizeStop = function (t, r) {
                            if ((e.prototype.segResizeStop.call(this, t, r), this.component.eventTitleFollower))
        ...
        function (e, t, r) {
            function o(e) {
                (e.labelInterval = n(e, 'slotLabelInterval')),
                    (e.slotDuration = n(e, 'slotDuration')),
                    i(e),
                    s(e),
                    a(e);
                var t = e.opt('slotLabelFormat'),
                    r = c.type(t);
                (e.headerFormats = 'array' === r ? t : 'string' === r ? [t] : l(e)),
                    (e.isTimeScale = d.durationHasTime(e.slotDuration));
                var o = null;
                if (!e.isTimeScale) {
                ...
                (e.largeUnit = o),
                    (e.emphasizeWeeks =
                        1 === e.slotDuration.as('days') && e.currentRangeAs('weeks') >= 2 && !e.opt('businessHours'));
                var p = e.opt('snapDuration');
                (e.snapDuration = p ? u.duration(p) : e.slotDuration),
                    (e.snapsPerSlot = d.divideDurationByDuration(e.slotDuration, e.snapDuration));
            }
            function n(e, t) {
                var r = e.opt(t);
                if (null != r) {
            ...
            function i(e) {
                ...
                if (e.labelInterval) {
                    ...
                    r > d.MAX_TIMELINE_SLOTS &&
                        (d.warn('slotLabelInterval results in too many cells'), (e.labelInterval = null));
                }
                if (e.slotDuration) {
                    var o = d.divideRangeByDuration(t.getStart(), t.getEnd(), e.slotDuration);
                    o > d.MAX_TIMELINE_SLOTS &&
                        (d.warn('slotDuration results in too many cells'), (e.slotDuration = null));
                }
                if (e.labelInterval && e.slotDuration) {
                    var n = d.divideDurationByDuration(e.labelInterval, e.slotDuration);
                    if (!d.isInt(n) || n < 1)
                        return d.warn('slotLabelInterval must be a multiple of slotDuration'), (e.slotDuration = null);
                }
            }
            function s(e) {
                var t = e.dateProfile.currentUnzonedRange,
            ...
            function l(e) {
                ...
                switch (('week' !== n || i || (n = 'day'), n)) {
                    ...
                    case 'week':
                        ...
                        break;
                    case 'day':
                        e.currentRangeAs('years') > 1
                            ? (s = e.opt('monthYearFormat'))
                            : e.currentRangeAs('months') > 1 && (s = 'MMMM'),
                            i && (t = e.opt('weekFormat')),
                            (r = 'dd D');
                        break;
                    case 'hour':
                        i && (s = e.opt('weekFormat')),
                            e.currentRangeAs('days') > 1 && (t = e.opt('dayOfMonthFormat')),
                            (r = e.opt('smallTimeFormat'));
                        break;
                    case 'minute':
                        o.asMinutes() / 60 >= p
                            ? ((s = e.opt('hourFormat')), (t = '[:]mm'))
                            : (s = e.opt('mediumTimeFormat'));
                        break;
                    case 'second':
                ...
                d = (function () {
                    function e(e) {
                        (this.colGroupHtml = ''),
                            ...
                            (this.givenColWidths = this.colWidths = this.view.colSpecs.map(function (e) {
                                return e.width;
                            }));
                    }
                    return (
                        (e.prototype.renderSkeleton = function () {
                            ...
                            (this.headScroller = new i['default']({
                                ...
                                (this.headScroller.canvas = new s['default']()),
                                ...
                                (this.bodyScroller = new i['default']({ overflowY: 'clipped-scroll' })),
                                (this.bodyScroller.canvas = new s['default']()),
                                ...
                                (this.scrollJoiner = new a['default']('horizontal', [
                                    this.headScroller,
                                    this.bodyScroller,
                                ])),
                        ...
                        (e.prototype.renderHeadHtml = function () {
                            for (
                                var e = this.view.calendar.theme,
                                    t = this.view.colSpecs,
                                    r = '<table class="' + e.getClass('tableGrid') + '">',
                                    o = '<colgroup>',
                                    i = 0,
                                    s = t;
                                i < s.length;
                            ...
                            for (var l = 0; l < t.length; l++) {
                                ...
                                r +=
                                    ...
                                    n.htmlEscape(a.labelText || '') +
                                    '</span></div>' +
                                    (c ? '' : '<div class="fc-col-resizer"></div>') +
                                    '</div></th>';
                            }
                        ...
                        (e.prototype.applyColWidths = function () {
                            for (
                                ...
                                (r = c[l]), 'number' == typeof r ? (a += r) : ((i = !1), r && (s = !0));
                            ...
                            for (t = 0; t < d.length; t++)
                                (e = d[t]),
                                    this.headColEls.eq(t).css('width', e),
                                    this.bodyColEls.eq(t).css('width', e);
                            this.headScroller.canvas.setMinWidth(h),
                                this.bodyScroller.canvas.setMinWidth(h),
                                (this.tableMinWidth = h),
                                (this.tableWidth = i ? a : void 0);
                        }),
                        (e.prototype.computeColMinWidths = function () {
                            ...
                            return this.givenColWidths.map(function (t, r) {
                                return 'number' == typeof t
                                    ? t
                                    : parseInt(e.headColEls.eq(r).css('min-width'), 10) || u;
                            });
                        }),
                        (e.prototype.queryColWidths = function () {
                            return this.headCellEls
                                .map(function (e, t) {
                        ...
                        (e.prototype.updateCellFollower = function () {
                            this.cellFollower && this.cellFollower.clearSprites(),
                                (this.cellFollower = new l['default'](this.bodyScroller, !0)),
                                (this.cellFollower.isHFollowing = !1),
                                (this.cellFollower.isVFollowing = !0);
        ...
        function (e, t) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }), (t.getOwnCells = r);
        },
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
            var o = r(1),
                ...
                i = (function (e) {
                    ...
                    return (
                        o.__extends(t, e),
                        (t.prototype.renderFgRanges = function (e) {}),
                    ...
                    return (
                        ...
                        (t.prototype.renderSkeleton = function () {
                            e.prototype.renderSkeleton.call(this),
                                ...
                                this.eventsPayload &&
                                    s['default'].prototype.executeEventRender.call(this, this.eventsPayload),
                                this.businessHourGenerator &&
                                    this.view.dateProfile &&
                                    s['default'].prototype.renderBusinessHours.call(this, this.businessHourGenerator),
                        ...
                        (t.prototype.removeElement = function () {
                            e.prototype.removeElement.call(this),
                                this.eventsPayload &&
                                    s['default'].prototype.executeEventUnrender.call(this, this.eventsPayload),
                                this.businessHourGenerator &&
                                    s['default'].prototype.unrenderBusinessHours.call(this, this.businessHourGenerator);
                        }),
                        ...
                        (t.prototype.executeEventRender = function (t) {
                            (this.eventsPayload = t),
                                this.get('isInDom') && e.prototype.executeEventRender.call(this, this.eventsPayload);
                        }),
                        (t.prototype.executeEventUnrender = function () {
                            e.prototype.executeEventUnrender.call(this), (this.eventsPayload = null);
                        }),
                        (t.prototype.renderBusinessHours = function (t) {
                            (this.businessHourGenerator = t),
                                this.get('isInDom') &&
                                    e.prototype.renderBusinessHours.call(this, this.businessHourGenerator);
                        }),
                        ...
                        (t.prototype.renderSpreadsheetSkeleton = function (e) {
                            for (
                                var t = this.view.calendar.theme, r = this.resource, o = 0, s = this.view.colSpecs;
                                o < s.length;
                                o++
                            ) {
                                var a = s[o];
                                if (!a.group) {
                                    var l = a.field ? r[a.field] || null : r,
                                        ...
                                        u = n(
                                            '<div class="fc-cell-content">' +
                                                (a.isMain ? this.renderGutterHtml() : '') +
                                                '<span class="fc-cell-text">' +
                                                (c ? i.htmlEscape(c) : '&nbsp;') +
                                                '</span></div>'
                                        );
                ...
                s = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.renderSpreadsheetSkeleton = function (e) {
                            ...
                            return (
                                t.prepend('<span class="fc-expander"><span class="fc-icon"></span></span>'),
                                n('<td class="fc-divider" />')
                                    .attr('colspan', this.view.colSpecs.length)
                                    .append(n('<div/>').append(t))
                                    .appendTo(e)
                            );
                        }),
                        (t.prototype.renderEventSkeleton = function (e) {
        ...
        function (e, t, r) {
            ...
            (n.Calendar.defaults.refetchResourcesOnNavigate = !1),
                (n.Calendar.defaults.filterResourcesWithEvents = !1),
                (n.Calendar.prototype.resourceManager = null),
                (n.Calendar.prototype.constructed = function () {
                ...
                (n.Calendar.prototype.instantiateView = function (e) {
                    ...
                    return (
                        this.opt('resources') &&
                            t.options.resources !== !1 &&
                            (t.queryResourceClass
                                ? (r = t.queryResourceClass(t) || r)
                                : t.resourceClass && (r = t.resourceClass)),
                        new r(this, t)
                    );
                }),
                ...
                (n.Calendar.prototype.addResource = function (e, t) {
                    var r = this;
                    void 0 === t && (t = !1),
                        this.resourceManager.addResource(e).then(function (e) {
                ...
                (n.Calendar.prototype.setEventResourceIds = function (e, t) {
                    ...
                    r &&
                        (r.resourceIds = t.map(function (e) {
        ...
        function (e, t, r) {
            ...
            var o = r(1),
                ...
                s = (function (e) {
                    ...
                    return (
                        o.__extends(t, e),
                        (t.prototype.getResources = function (e, t) {
                            var r =
                                (!e && !this.currentStart) ||
                                (e && this.currentStart && e.isSame(this.currentStart) && t.isSame(this.currentEnd));
                        ...
                        (t.prototype.fetchResourceInputs = function (e, r, o) {
                            var i = this,
                                ...
                                a = s.opt('resources'),
                                l = s.opt('timezone');
                            switch (('string' === n.type(a) && (a = { url: a }), n.type(a))) {
                                case 'function':
                                ...
                                case 'object':
                                    ...
                                    r &&
                                        o &&
                                        ((c[s.opt('startParam')] = r.format()),
                                        (c[s.opt('endParam')] = o.format()),
                                        l && 'local' !== l && (c[s.opt('timezoneParam')] = l)),
                                        n.ajax(n.extend({ data: c }, t.ajaxDefaults, a)).then(function (t) {
                                            s.popLoading(), e(t);
                                        });
                                    break;
                                case 'array':
                        ...
                        (t.prototype.setResources = function (e) {
                            ...
                            for (
                                ...
                                (t = a[s]), this.addResourceToIndex(t) && i.push(t);
                        ...
                        (t.prototype.addResource = function (e) {
                            ...
                            return this.fetching
                                ? this.fetching.then(function () {
                                      ...
                                      return (
                                          !!t.addResourceToIndex(r) &&
                                          (t.addResourceToTree(r), t.trigger('add', r, t.topLevelResources), r)
                                      );
                                  })
                                : i.Promise.reject();
                        }),
                        ...
                        (t.prototype.removeResource = function (e) {
                            ...
                            return this.fetching
                                ? this.fetching.then(function () {
                                      ...
                                      return (
                                          e &&
                                              (t.removeResourceFromTree(e),
                                              t.trigger('remove', e, t.topLevelResources)),
                                          e
                                      );
                                  })
                                : i.Promise.reject();
                        ...
                        (t.prototype.buildResource = function (e) {
                            var r = this,
                                ...
                                s = e.eventClassName;
                            return (
                                (o.id = String(null != e.id ? e.id : '_fc' + t.resourceGuid++)),
                                (o.eventClassName = (function () {
                                    switch (n.type(s)) {
                                        case 'string':
                                            return s.split(/\s+/);
                                        case 'array':
                                ...
                                e.businessHours &&
                                    (o.businessHourGenerator = new i.BusinessHourGenerator(
                                        e.businessHours,
                                        this.calendar
                                    )),
                                (o.children = (e.children || []).map(function (e) {
                        ...
                        (t.resourceGuid = 1),
                        (t.ajaxDefaults = { dataType: 'json', cache: !1 }),
                        t
                    );
                })(i.Class);
        ...
        function (e, t, r) {
            ...
            (n.Constraints.prototype.getPeerEventInstances = function (e) {
                ...
                (n.Constraints.prototype.buildCurrentBusinessFootprints = function (e) {
                    for (
                        var t = this._calendar.resourceManager.getFlatResources(), r = !1, o = 0, n = t;
                        o < n.length;
                        o++
                    ) {
                        var i = n[o];
                    ...
                    if (r) {
                        for (
                            var l = this._calendar.view,
                                c = l.get('businessHourGenerator'),
                                u = l.dateProfile.activeUnzonedRange,
                                d = [],
                                h = 0,
                                p = t;
                            h < p.length;
                ...
                (n.Constraints.prototype.footprintContainsFootprint = function (e, t) {
                    return (
                        (!(e instanceof s['default']) ||
                            (t instanceof s['default'] && t.resourceId === e.resourceId)) &&
                        a.footprintContainsFootprint.apply(this, arguments)
                    );
                }),
                (n.Constraints.prototype.footprintsIntersect = function (e, t) {
                    return (
                        !(e instanceof s['default'] && t instanceof s['default'] && e.resourceId !== t.resourceId) &&
                        a.footprintsIntersect.apply(this, arguments)
                    );
                }),
                (n.Constraints.prototype.eventRangeToEventFootprints = function (e) {
                    ...
                    return r.length
                        ? r.map(function (r) {
                              return new n.EventFootprint(
                                  new s['default'](e.unzonedRange, t.isAllDay(), r),
                                  t,
                                  e.eventInstance
                              );
                          })
        ...
        function (e, t, r) {
            ...
            (n.View.prototype.canHandleSpecificResources = !1),
                (n.View.prototype.setElement = function () {
                ...
                (n.View.prototype.triggerViewRender = function () {
                    i.processLicenseKey(this.opt('schedulerLicenseKey'), this.el),
                        s.triggerViewRender.apply(this, arguments);
                }),
                (n.View.prototype.watchResources = function () {
                    ...
                    this.opt('refetchResourcesOnNavigate') && t.push('dateProfile'),
                        this.opt('filterResourcesWithEvents') && r.push('currentEvents'),
                        this.watch('initialResources', t, function (t) {
                        ...
                        this.watch(
                            ...
                            r,
                            function (t) {
                                e.bindResourceChanges(t.currentEvents),
                ...
                (n.View.prototype.getInitialResources = function (e) {
                    var t = this.calendar;
                    return e
                        ? t.resourceManager.getResources(
                              t.msToMoment(e.activeUnzonedRange.startMs, e.isRangeAllDay),
                              t.msToMoment(e.activeUnzonedRange.endMs, e.isRangeAllDay)
                          )
                        : t.resourceManager.getResources();
                }),
                ...
                n.View.watch(
                    'displayingEvents',
                    ['displayingDates', 'hasEvents', 'currentResources'],
                    function (e) {
                ...
                (n.View.prototype.setResources = function (e, t) {
                    t && (e = this.filterResourcesWithEvents(e, t)),
                        this.set('currentResources', e),
                        this.set('hasResources', !0);
                }),
                ...
                (n.View.prototype.removeResource = function (e, t, r) {
                    return this.canHandleSpecificResources
                        ? (this.set('currentResources', t), void this.handleResourceRemove(e))
                        : void this.resetResources(t, r);
                }),
                (n.View.prototype.handleResourceAdd = function (e) {}),
                (n.View.prototype.handleResourceRemove = function (e) {}),
                (n.View.prototype.filterResourcesWithEvents = function (e, t) {
        ...
        function (e, t, r) {
            function o(e, t) {
                if (!i(window.location.href) && !n(e) && !a(t))
                    return s('Please use a valid license key. <a href="' + p + '">More Info</a>', t);
            }
            function n(e) {
            ...
            (t.processLicenseKey = o),
                (t.isValidKey = n),
                (t.isImmuneUrl = i),
                (t.renderingWarningInContainer = s),
                (t.detectWarningInContainer = a);
        },
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
            var o = r(0),
                n = r(6),
                i = { eventRangeToEventFootprints: o.DateComponent.prototype.eventRangeToEventFootprints };
            (o.DateComponent.prototype.isResourceFootprintsEnabled = !1),
                (o.DateComponent.prototype.eventRangeToEventFootprints = function (e) {
                    if (this.isResourceFootprintsEnabled) {
                        var t = e.eventDef,
                            r = t.getResourceIds();
                        return r.length
                            ? r.map(function (r) {
                                  return new o.EventFootprint(
                                      new n['default'](e.unzonedRange, t.isAllDay(), r),
                                      t,
                                      e.eventInstance
                                  );
                              })
                            : t.hasBgRendering()
                            ? i.eventRangeToEventFootprints.apply(this, arguments)
                            : [];
                    }
        ...
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
            var o = r(0),
                n = { isEventDefDraggable: o.InteractiveDateComponent.prototype.isEventDefDraggable };
            (o.InteractiveDateComponent.prototype.allowCrossResource = !0),
                (o.InteractiveDateComponent.prototype.isEventDefDraggable = function (e) {
                ...
                (o.InteractiveDateComponent.prototype.isEventDefResourceEditable = function (e) {
                    ...
                    return (
                        null == t &&
                            ((t = (e.source || {}).resourceEditable),
                            null == t &&
                                ((t = this.opt('eventResourceEditable')),
                                null == t && (t = this.isEventDefGenerallyEditable(e)))),
                        t
                    );
                });
        },
        function (e, t, r) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 });
            var n = r(0),
                i = { getFallbackStylingObjs: n.EventRenderer.prototype.getFallbackStylingObjs };
            (n.EventRenderer.prototype.designatedResource = null),
                (n.EventRenderer.prototype.currentResource = null),
                (n.EventRenderer.prototype.beforeFgSegHtml = function (e) {
                    var t = e.footprint.componentFootprint.resourceId;
                    this.designatedResource
                        ? (this.currentResource = this.designatedResource)
                        : t
                        ? (this.currentResource = o(this, t))
        ...
        function (e, t, r) {
            ...
            var o = r(0),
                n = r(6),
                i = { computeSelectionFootprint: o.DateSelecting.prototype.computeSelectionFootprint };
            o.DateSelecting.prototype.computeSelectionFootprint = function (e, t) {
                if (e.resourceId && t.resourceId && e.resourceId !== t.resourceId && !this.component.allowCrossResource)
                    return null;
        ...
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
            var o = r(0),
                n = { computeEventDropMutation: o.EventDragging.prototype.computeEventDropMutation };
            o.EventDragging.prototype.computeEventDropMutation = function (e, t, r) {
                ...
                if (
                    ...
                    this.component.isEventDefResourceEditable(r)
                ) {
                    var s = new o.EventDefMutation();
                    return (
                        (s.oldResourceId = e.resourceId),
                        (s.newResourceId = t.resourceId),
                        i && s.setDateMutation(this.computeEventDateMutation(e, t)),
                        s
                    );
                }
        ...
        function (e, t, r) {
            ...
            (o.EventResizing.prototype.computeEventStartResizeMutation = function (e, t, r) {
                return e.resourceId &&
                    ...
                    ? null
                    : n.computeEventStartResizeMutation.apply(this, arguments);
            }),
                (o.EventResizing.prototype.computeEventEndResizeMutation = function (e, t, r) {
                    return e.resourceId &&
                        ...
                        !this.component.allowCrossResource
                        ? null
                        : n.computeEventEndResizeMutation.apply(this, arguments);
                });
        },
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
            var o = r(0),
                n = { computeExternalDrop: o.ExternalDropping.prototype.computeExternalDrop };
        ...
        function (e, t, r) {
            ...
            n.EventDef.defineStandardProps({ resourceEditable: !0 }),
                (n.EventDef.prototype.resourceIds = null),
                (n.EventDef.prototype.resourceEditable = null),
                (n.EventDef.prototype.applyMiscProps = function (e) {
                    (e = o.extend({}, e)),
                        (this.resourceIds = i['default'].extractIds(e, this.source.calendar)),
                        delete e.resourceId,
                        delete e.resourceIds,
                        s.applyMiscProps.apply(this, arguments);
                }),
                ...
                (n.EventDef.prototype.toLegacy = function () {
                    ...
                    return (
                        (e.resourceId = 1 === t.length ? t[0] : null),
                        (e.resourceIds = t.length > 1 ? t : null),
                        null != this.resourceEditable && (e.resourceEditable = this.resourceEditable),
                        e
                    );
                });
        },
        function (e, t, r) {
            ...
            (o.EventDefMutation.prototype.oldResourceId = null),
                (o.EventDefMutation.prototype.newResourceId = null),
                (o.EventDefMutation.prototype.mutateSingle = function (e) {
                    var t = n.apply(this, arguments),
                        r = null;
                    return (
                        this.oldResourceId &&
                            e.hasResourceId(this.oldResourceId) &&
                            ((r = e.getResourceIds()),
                            e.removeResourceId(this.oldResourceId),
                            e.addResourceId(this.newResourceId)),
                        function () {
                            t(), r && (e.resourceIds = r);
                        }
                    );
        ...
        function (e, t, r) {
            ...
            var o = r(0),
                n = r(14);
            o.defineView('timeline', { class: n['default'], defaults: { eventResizableFromStart: !0 } }),
                o.defineView('timelineDay', { type: 'timeline', duration: { days: 1 } }),
                o.defineView('timelineWeek', { type: 'timeline', duration: { weeks: 1 } }),
                o.defineView('timelineMonth', { type: 'timeline', duration: { months: 1 } }),
                o.defineView('timelineYear', { type: 'timeline', duration: { years: 1 } });
        },
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
            var o = r(0),
                n = r(30);
            (o.getViewConfig('timeline').resourceClass = n['default']),
                (o.Calendar.defaults.resourcesInitiallyExpanded = !0);
        },
        function (e, t, r) {
            Object.defineProperty(t, '__esModule', { value: !0 });
            var o = r(0),
