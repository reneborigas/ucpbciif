...
class Document(models.Model):
    ...
    parentDocument = models.ForeignKey(
        "documents.Document", on_delete=models.SET_NULL, related_name="childDocuments", null=True, blank=True
    )
    loan = models.ForeignKey(
        "loans.Loan", on_delete=models.CASCADE, related_name="loanDocuments", blank=True, null=True
    )
    creditLine = models.ForeignKey(
        "loans.CreditLine", on_delete=models.CASCADE, related_name="creditLineDocuments", blank=True, null=True
    )
